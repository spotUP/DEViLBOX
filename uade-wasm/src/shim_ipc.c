                         ...
                         const char *playerdir)
{
    ...
    /* Verbose file-lookup logging removed — was flooding browser console with WASM stack traces */
    ...
    /* resolved logging removed — verbose */
    ...
    /* SUCCESS logging removed — verbose */
    return 0;
}
