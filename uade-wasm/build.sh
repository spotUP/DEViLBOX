...
LDFLAGS=(
    ...
    # WASM exports
    "-sEXPORTED_FUNCTIONS=['_uade_wasm_init','_uade_wasm_load','_uade_wasm_render','_uade_wasm_stop','_uade_wasm_get_subsong_count','_uade_wasm_get_subsong_min','_uade_wasm_get_subsong_max','_uade_wasm_get_player_name','_uade_wasm_get_format_name','_uade_wasm_set_subsong','_uade_wasm_set_looping','_uade_wasm_cleanup','_uade_wasm_get_channel_snapshot','_uade_wasm_get_total_frames','_malloc','_free']"
    "-sEXPORTED_RUNTIME_METHODS=['ccall','cwrap','stringToUTF8','UTF8ToString','HEAPU8','HEAPF32']"
