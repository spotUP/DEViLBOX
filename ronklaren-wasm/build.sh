...
emcc -O2 -Wall -Wextra -Wno-unused-function -Wno-unused-variable -Wno-tautological-constant-out-of-range-compare \
    ...
    -sEXPORTED_FUNCTIONS="['_rk_create','_rk_destroy','_rk_subsong_count','_rk_select_subsong','_rk_channel_count','_rk_set_channel_mask','_rk_render','_rk_render_multi','_rk_has_ended','_malloc','_free']" \
