...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_gmc_create','_gmc_destroy','_gmc_subsong_count','_gmc_select_subsong','_gmc_channel_count','_gmc_set_channel_mask','_gmc_render','_gmc_render_multi','_gmc_has_ended','_gmc_get_instrument_count','_gmc_get_num_patterns','_gmc_get_cell','_gmc_set_cell','_gmc_get_instrument_param','_gmc_set_instrument_param','_gmc_export','_malloc','_free']" \
