...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_vs_create','_vs_destroy','_vs_subsong_count','_vs_select_subsong','_vs_channel_count','_vs_set_channel_mask','_vs_render','_vs_render_multi','_vs_has_ended','_vs_get_instrument_count','_vs_get_instrument_param','_vs_set_instrument_param','_vs_export','_malloc','_free']" \
