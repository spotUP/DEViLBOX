...
/* DMA startup delay log for A/B comparison with MLINE */
#define DMA_DELAY_MAX 65536
struct dma_delay_entry {
    int channel;
    int delay;
};
extern struct dma_delay_entry dma_delay_log[DMA_DELAY_MAX];
extern int dma_delay_log_count;
