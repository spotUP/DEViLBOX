...
*****************************************************************************
                ...
                EPPHEADER PlayerTagArray                        ; define start of header
...
Play8channels
                ; Record ch_Play bit 0 for all 8 channels via trap $f0ff18
                ; (before Play8ch clears them with bclr)
                moveq   #0,d0
                move.b  Channel1Buf+ch_Play,d0
                moveq   #0,d1
                move.b  Channel2Buf+ch_Play,d1
                moveq   #0,d2
                move.b  Channel3Buf+ch_Play,d2
                moveq   #0,d3
                move.b  Channel4Buf+ch_Play,d3
                moveq   #0,d4
                move.b  Channel5Buf+ch_Play,d4
                moveq   #0,d5
                move.b  Channel6Buf+ch_Play,d5
                moveq   #0,d6
                move.b  Channel7Buf+ch_Play,d6
                moveq   #0,d7
                move.b  Channel8Buf+ch_Play,d7
                move.l  d7,-(sp)
                move.l  d6,-(sp)
                move.l  d5,-(sp)
                move.l  d4,-(sp)
