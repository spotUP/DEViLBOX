...
emcc -O2 -Wall -Wextra -Wno-unused-function -Wno-unused-variable -Wno-tautological-constant-out-of-range-compare \
    ...
    -sEXPORTED_FUNCTIONS="['_avp_create','_avp_destroy','_avp_subsong_count','_avp_select_subsong','_avp_channel_count','_avp_set_channel_mask','_avp_render','_avp_render_multi','_avp_has_ended','_avp_get_instrument_count','_avp_get_instrument_param','_avp_set_instrument_param','_avp_export','_malloc','_free']" \
