/*
 * PreTracker WASM harness
 * Loads .pre module → InitPlayer → drives Interrupt at 50Hz → renders via Paula
 */

#include "pretracker/paula_soft.c"
#include "pretracker/pretracker.c"  /* unity build */
#include <stdlib.h>
#include <string.h>
