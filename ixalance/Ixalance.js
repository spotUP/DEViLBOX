...
function findWasmBinary() {
    return locateFile('Ixalance.wasm');
}
...
var _ixalance_init = Module['_ixalance_init'] = makeInvalidEarlyAccess('_ixalance_init');
...
function assignWasmExports(wasmExports) {
  _ixalance_init = Module['_ixalance_init'] = createExportWrapper('ixalance_init', 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createIxalance;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createIxalance;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createIxalance);
