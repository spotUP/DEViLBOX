...
emcc \
    ...
    -sEXPORTED_FUNCTIONS="['_sa_create','_sa_destroy','_sa_subsong_count','_sa_select_subsong','_sa_channel_count','_sa_set_channel_mask','_sa_render','_sa_has_ended','_malloc','_free']" \
