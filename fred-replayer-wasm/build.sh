...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_fred_create','_fred_destroy','_fred_subsong_count','_fred_select_subsong','_fred_channel_count','_fred_set_channel_mask','_fred_render','_fred_render_multi','_fred_has_ended','_fred_get_instrument_count','_fred_get_instrument_name','_fred_get_instrument_param','_fred_set_instrument_param','_fred_export','_malloc','_free']" \
