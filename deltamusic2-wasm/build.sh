...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_dm2_create','_dm2_destroy','_dm2_subsong_count','_dm2_select_subsong','_dm2_channel_count','_dm2_set_channel_mask','_dm2_render','_dm2_render_multi','_dm2_has_ended','_dm2_get_instrument_count','_dm2_get_num_blocks','_dm2_get_cell','_dm2_set_cell','_dm2_get_instrument_param','_dm2_set_instrument_param','_dm2_export','_malloc','_free']" \
