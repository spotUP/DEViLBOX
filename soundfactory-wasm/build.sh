...
emcc -O2 -Wall -Wextra -Wno-unused-function -Wno-unused-variable -Wno-tautological-constant-out-of-range-compare \
    ...
    -sEXPORTED_FUNCTIONS="['_sf_create','_sf_destroy','_sf_subsong_count','_sf_select_subsong','_sf_channel_count','_sf_set_channel_mask','_sf_render','_sf_render_multi','_sf_has_ended','_sf_get_instrument_count','_sf_export','_malloc','_free']" \
