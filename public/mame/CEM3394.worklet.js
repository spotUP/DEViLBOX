/**
 * CEM3394 AudioWorklet Processor
...
class CEM3394Processor extends AudioWorkletProcessor {
  ...
  async initSynth(data) {
    try {
      ...
      this.module = await globalThis.initMAMEWasmModule(data.wasmBinary, data.jsCode, 'createCEM3394Module');

      // Create synth instance
      this.synth = new this.module.CEM3394Synth();
      ...
      console.error('CEM3394 init error:', error);
...
registerProcessor('cem3394-processor', CEM3394Processor);
