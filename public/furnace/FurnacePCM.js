...
function findWasmBinary() {
    return locateFile('FurnacePCM.wasm');
}
...
function assignWasmExports(wasmExports) {
  _furnace_pcm_init = Module['_furnace_pcm_init'] = createExportWrapper('furnace_pcm_init', 2);
  _free = Module['_free'] = createExportWrapper('free', 1);
  _furnace_pcm_start = Module['_furnace_pcm_start'] = createExportWrapper('furnace_pcm_start', 0);
  _furnace_pcm_shutdown = Module['_furnace_pcm_shutdown'] = createExportWrapper('furnace_pcm_shutdown', 0);
  _furnace_pcm_load_config = Module['_furnace_pcm_load_config'] = createExportWrapper('furnace_pcm_load_config', 2);
  _furnace_pcm_dump_config = Module['_furnace_pcm_dump_config'] = createExportWrapper('furnace_pcm_dump_config', 2);
  _furnace_pcm_load_pcm = Module['_furnace_pcm_load_pcm'] = createExportWrapper('furnace_pcm_load_pcm', 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createFurnacePCM;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createFurnacePCM;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createFurnacePCM);
