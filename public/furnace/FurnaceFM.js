...
function findWasmBinary() {
    return locateFile('FurnaceFM.wasm');
}
...
function assignWasmExports(wasmExports) {
  _furnace_fm_init = Module['_furnace_fm_init'] = createExportWrapper('furnace_fm_init', 2);
  _furnace_fm_start = Module['_furnace_fm_start'] = createExportWrapper('furnace_fm_start', 0);
  _furnace_fm_shutdown = Module['_furnace_fm_shutdown'] = createExportWrapper('furnace_fm_shutdown', 0);
  _furnace_fm_load_config = Module['_furnace_fm_load_config'] = createExportWrapper('furnace_fm_load_config', 2);
  _furnace_fm_dump_config = Module['_furnace_fm_dump_config'] = createExportWrapper('furnace_fm_dump_config', 2);
...
var wasmImports = {
  ...
  fd_write: _fd_write,
  /** @export */
  js_on_algorithm_change,
  /** @export */
  js_on_op_param_change,
  /** @export */
  js_on_param_change
};
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createFurnaceFM;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createFurnaceFM;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createFurnaceFM);
