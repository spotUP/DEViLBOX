...
emcc -O2 -Wall -Wextra -Wno-unused-function -Wno-unused-variable -Wno-tautological-constant-out-of-range-compare \
    ...
    -sEXPORTED_FUNCTIONS="['_syn_create','_syn_destroy','_syn_subsong_count','_syn_select_subsong','_syn_channel_count','_syn_set_channel_mask','_syn_render','_syn_render_multi','_syn_has_ended','_syn_get_instrument_count','_syn_export','_malloc','_free']" \
