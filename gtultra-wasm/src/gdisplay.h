/* gdisplay.h — Stub for WASM build (provides declarations + constants, bodies in bridge) */
#ifndef GDISPLAY_H
#define GDISPLAY_H
...
/* All display functions are no-ops in WASM (UI handled by JS) */
...
int getPaletteTextArraySize(void);
