...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_sc_create','_sc_destroy','_sc_subsong_count','_sc_select_subsong','_sc_channel_count','_sc_set_channel_mask','_sc_render','_sc_render_multi','_sc_has_ended','_sc_get_instrument_count','_sc_get_num_samples','_sc_get_instrument_param','_sc_set_instrument_param','_sc_export','_malloc','_free']" \
