...
public:
    ...
    /**
     * DEViLBOX extension: trigger a single instrument macro for editor
     * preview. Default implementation is a no-op so non-TFMX decoders
     * (FC, Hippel CoSo, etc.) ignore it gracefully. TFMXDecoder overrides
     * to set up cmd.aa/bb/cd/ee and call its private noteCmd path.
     */
