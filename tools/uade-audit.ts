...
const TESTS: TestDef[] = [
  ...
  { key: 'uade-jason-page',         path: 'pub/modules/Jason Page/Jason Page/jpn.empiresoccer94',
                                     companions: ['pub/modules/Jason Page/Jason Page/smp.empiresoccer94'] },
  ...
  { key: 'uade-richard-joseph',     path: 'pub/modules/Richard Joseph/Richard Joseph/cannon fodder 2.sng',
                                     companions: ['pub/modules/Richard Joseph/Richard Joseph/cannon fodder 2.ins'] },
  ...
  { key: 'uade-thomas-hermann',     path: 'pub/modules/Thomas Hermann/Thomas Hermann/thm.blueangel69',
                                     companions: ['pub/modules/Thomas Hermann/Thomas Hermann/smp.blueangel69'] },
  ...
  { key: 'uade-kris-hatlelid',      path: 'pub/modules/Kris Hatlelid/Kris Hatlelid/The Cycles/the cycles.kh',
                                     companions: ['pub/modules/Kris Hatlelid/Kris Hatlelid/The Cycles/songplay'] },
  { key: 'uade-magnetic-fields',    path: 'pub/modules/Magnetic Fields Packer/Jeff Rourke/mfp.crystaldragon ingame',
                                     companions: ['pub/modules/Magnetic Fields Packer/Jeff Rourke/smp.crystaldragon ingame'] },
  ...
  { key: 'uade-quartet',            path: 'pub/modules/Quartet ST/607/Intense Stuff.4v',
                                     companions: ['pub/modules/Quartet ST/607/Intense Stuff.set'] },
