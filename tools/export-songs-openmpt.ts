...
const TEST_CASES: TestCase[] = [
  ...
  { file: 'formats/antidust.bp3', format: 'SMON', parserModule: 'SoundMonParser', parseFn: 'parseSoundMonFile', isAsync: true, exportAs: 'xm' },
  { file: 'formats/aquarivs.bp', format: 'SMON', parserModule: 'SoundMonParser', parseFn: 'parseSoundMonFile', isAsync: true, exportAs: 'xm' },
  ...
  { file: 'formats/crusaders1.dm', format: 'DM1', parserModule: 'DeltaMusic1Parser', parseFn: 'parseDeltaMusic1File', isAsync: true, exportAs: 'xm' },
  { file: 'formats/anthrox_intro.dm2', format: 'DM2', parserModule: 'DeltaMusic2Parser', parseFn: 'parseDeltaMusic2File', isAsync: false, args: 'bytes', exportAs: 'xm' },
  { file: 'formats/cockwise.mug', format: 'DMUG', parserModule: 'DigitalMugicianParser', parseFn: 'parseDigitalMugicianFile', isAsync: true, exportAs: 'xm' },
  { file: 'formats/snickle.mug2', format: 'DMUG', parserModule: 'DigitalMugicianParser', parseFn: 'parseDigitalMugicianFile', isAsync: true, exportAs: 'xm' },
  { file: 'formats/flight.dmu', format: 'DMUG', parserModule: 'DigitalMugicianParser', parseFn: 'parseDigitalMugicianFile', isAsync: true, exportAs: 'xm' },
  { file: 'formats/anarchy.sid1', format: 'SIDMON1', parserModule: 'SidMon1Parser', parseFn: 'parseSidMon1File', isAsync: false, exportAs: 'xm' },
  ...
  { file: 'formats/prehistoric_tale.hipc', format: 'HIPC', parserModule: 'HippelCoSoParser', parseFn: 'parseHippelCoSoFile', isAsync: true, exportAs: 'xm' },
  ...
  { file: 'formats/apb.dw', format: 'DW', parserModule: 'DavidWhittakerParser', parseFn: 'parseDavidWhittakerFile', isAsync: false, exportAs: 'xm' },
