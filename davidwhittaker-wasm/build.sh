...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_dw_create','_dw_destroy','_dw_subsong_count','_dw_select_subsong','_dw_channel_count','_dw_set_channel_mask','_dw_render','_dw_render_multi','_dw_has_ended','_dw_get_instrument_count','_dw_get_instrument_param','_dw_set_instrument_param','_dw_export','_malloc','_free']" \
