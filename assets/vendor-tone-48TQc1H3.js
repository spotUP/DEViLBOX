...
const BACKUP_NATIVE_CONTEXT_STORE = /* @__PURE__ */ new WeakMap();
...
const createAddAudioWorkletModule = (createNotSupportedError2, evaluateSource, exposeCurrentFrameAndCurrentTime2, fetchSource, getBackupNativeContext2, getNativeContext2, ongoingRequests, resolvedRequests, window2) => {
  return (context2, moduleURL, options = { credentials: "omit" }) => {
    const nativeContext = getNativeContext2(context2);
    const absoluteUrl = new URL(moduleURL, window2.location.href).toString();
    if (nativeContext.audioWorklet !== void 0) {
      return fetchSource(moduleURL).then((source) => {
        ...
        const backupNativeContext = getBackupNativeContext2(nativeContext);
        const nativeContextOrBackupNativeContext = backupNativeContext !== null ? backupNativeContext : nativeContext;
        return nativeContextOrBackupNativeContext.audioWorklet.addModule(url, options).then(() => URL.revokeObjectURL(url)).catch((err) => {
          URL.revokeObjectURL(url);
          if (err.code === void 0 || err.name === "SyntaxError") {
            err.code = 12;
          }
          throw err;
        });
...
const createAddSilentConnection = (createNativeGainNode2) => {
  return (nativeContext, nativeAudioScheduledSourceNode) => {
    ...
    nativeAudioScheduledSourceNode.connect(nativeGainNode).connect(nativeGainNode.context.destination);
    const disconnect2 = () => {
...
const createAnalyserNodeConstructor = (audionNodeConstructor, createAnalyserNodeRenderer2, createIndexSizeError2, createNativeAnalyserNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class AnalyserNode extends audionNodeConstructor {
    constructor(context2, options = DEFAULT_OPTIONS$j) {
      const nativeContext = getNativeContext2(context2);
...
const createAudioBufferSourceNodeConstructor = (audioNodeConstructor2, createAudioBufferSourceNodeRenderer2, createAudioParam2, createInvalidStateError2, createNativeAudioBufferSourceNode2, getNativeContext2, isNativeOfflineAudioContext2, wrapEventListener2) => {
  return class AudioBufferSourceNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$h) {
      const nativeContext = getNativeContext2(context2);
      ...
      this._isBufferSet = options.buffer !== null && options.buffer !== void 0;
    ...
    start(when = 0, offset = 0, duration) {
      ...
      if (this._audioBufferSourceNodeRenderer !== null) {
        ...
        const resetInternalStateToPassive = () => {
          ...
          setTimeout(() => setInternalStateToPassive(this), 1e3);
        };
...
const createAudioContextConstructor = (baseAudioContextConstructor2, createInvalidStateError2, createNotSupportedError2, createUnknownError2, mediaElementAudioSourceNodeConstructor2, mediaStreamAudioDestinationNodeConstructor2, mediaStreamAudioSourceNodeConstructor2, mediaStreamTrackAudioSourceNodeConstructor2, nativeAudioContextConstructor2) => {
  return class AudioContext extends baseAudioContextConstructor2 {
    constructor(options = {}) {
      ...
      const nativeAudioContext = new nativeAudioContextConstructor2(options);
...
const createAudioListenerFactory = (createAudioParam2, createNativeChannelMergerNode2, createNativeConstantSourceNode2, createNativeScriptProcessorNode2, isNativeOfflineAudioContext2) => {
...
const createAudioNodeConstructor = (addAudioNodeConnections, auxiliaryGainNodeStore2, cacheTestResult2, createIncrementCycleCounter, createIndexSizeError2, createInvalidAccessError2, createNotSupportedError2, decrementCycleCounter, detectCycles, eventTargetConstructor2, getNativeContext2, isNativeAudioContext2, isNativeAudioNode2, isNativeAudioParam2, isNativeOfflineAudioContext2) => {
  return class AudioNode extends eventTargetConstructor2 {
    ...
    connect(destination, output = 0, input = 0) {
      ...
      if (isAudioNode$1(destination)) {
        ...
        try {
          ...
          if (isAudioWorkletNode(destination)) {
            const auxiliaryGainNodes = auxiliaryGainNodeStore2.get(nativeDestinationAudioNode);
            if (auxiliaryGainNodes === void 0) {
              const nativeGainNode = nativeContext.createGain();
              nativeGainNode.connect(connection[0], 0, connection[2]);
              auxiliaryGainNodeStore2.set(nativeDestinationAudioNode, /* @__PURE__ */ new Map([[input, nativeGainNode]]));
            } else if (auxiliaryGainNodes.get(input) === void 0) {
              const nativeGainNode = nativeContext.createGain();
              nativeGainNode.connect(connection[0], 0, connection[2]);
        ...
        const isNewConnectionToAudioNode = isOffline ? addConnectionToAudioNodeOfOfflineAudioContext(this, destination, output, input) : addConnectionToAudioNodeOfAudioContext(this, destination, output, input);
      ...
      const isNewConnectionToAudioParam = isOffline ? addConnectionToAudioParamOfOfflineAudioContext(this, destination, output) : addConnectionToAudioParamOfAudioContext(this, destination, output);
    ...
    const audioParam = {
      ...
      setValueCurveAtTime(values, startTime, duration) {
        if (nativeAudioContextConstructor2 !== null && nativeAudioContextConstructor2.name === "webkitAudioContext") {
          ...
          automationEventList.add(createSetValueCurveAutomationEvent2(values, startTime, duration));
...
const createAudioWorkletNodeConstructor = (addUnrenderedAudioWorkletNode2, audioNodeConstructor2, createAudioParam2, createAudioWorkletNodeRenderer2, createNativeAudioWorkletNode2, getNativeContext2, isNativeOfflineAudioContext2, nativeAudioWorkletNodeConstructor2, wrapEventListener2) => {
  return class AudioWorkletNode extends audioNodeConstructor2 {
    constructor(context2, name, options = DEFAULT_OPTIONS$g) {
      const nativeContext = getNativeContext2(context2);
      const isOffline = isNativeOfflineAudioContext2(nativeContext);
      const mergedOptions = sanitizedOptions$1({ ...DEFAULT_OPTIONS$g, ...options });
      const nodeNameToProcessorConstructorMap = NODE_NAME_TO_PROCESSOR_CONSTRUCTOR_MAPS.get(nativeContext);
      const processorConstructor = nodeNameToProcessorConstructorMap === void 0 ? void 0 : nodeNameToProcessorConstructorMap.get(name);
      const nativeAudioWorkletNode = createNativeAudioWorkletNode2(nativeContext, isOffline ? null : context2.baseLatency, nativeAudioWorkletNodeConstructor2, name, processorConstructor, mergedOptions);
...
const processBuffer = async (proxy, renderedBuffer, nativeOfflineAudioContext, options, processorConstructor, exposeCurrentFrameAndCurrentTime2) => {
    ...
    const createAudioNode = async (proxy, nativeOfflineAudioContext, trace) => {
      ...
      if (nativeOutputNodes !== null) {
        if (processedBufferPromise === null) {
          ...
          processedBufferPromise = processBuffer(proxy, numberOfChannels === 0 ? null : await renderBuffer(), nativeOfflineAudioContext, options, processorConstructor, exposeCurrentFrameAndCurrentTime2);
        }
...
const createBiquadFilterNodeConstructor = (audioNodeConstructor2, createAudioParam2, createBiquadFilterNodeRenderer2, createInvalidAccessError2, createNativeBiquadFilterNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class BiquadFilterNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$f) {
      const nativeContext = getNativeContext2(context2);
...
const createChannelMergerNodeConstructor = (audioNodeConstructor2, createChannelMergerNodeRenderer2, createNativeChannelMergerNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class ChannelMergerNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$e) {
      const nativeContext = getNativeContext2(context2);
...
const createChannelSplitterNodeConstructor = (audioNodeConstructor2, createChannelSplitterNodeRenderer2, createNativeChannelSplitterNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class ChannelSplitterNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$d) {
      const nativeContext = getNativeContext2(context2);
      const mergedOptions = sanitizedOptions({ ...DEFAULT_OPTIONS$d, ...options });
...
const createConstantSourceNodeConstructor = (audioNodeConstructor2, createAudioParam2, createConstantSourceNodeRendererFactory2, createNativeConstantSourceNode2, getNativeContext2, isNativeOfflineAudioContext2, wrapEventListener2) => {
  return class ConstantSourceNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$c) {
      const nativeContext = getNativeContext2(context2);
...
const createConvolverNodeConstructor = (audioNodeConstructor2, createConvolverNodeRenderer2, createNativeConvolverNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class ConvolverNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$b) {
      const nativeContext = getNativeContext2(context2);
...
const createDecodeAudioData = (audioBufferStore2, cacheTestResult2, createDataCloneError2, createEncodingError2, detachedArrayBuffers, getNativeContext2, isNativeContext2, isNativeOfflineAudioContext2, nativeOfflineAudioContextConstructor2, testAudioBufferCopyChannelMethodsOutOfBoundsSupport2, testPromiseSupport2, wrapAudioBufferCopyChannelMethods2, wrapAudioBufferCopyChannelMethodsOutOfBounds2) => {
  return (anyContext, audioData) => {
    ...
    if (cacheTestResult2(testPromiseSupport2, () => testPromiseSupport2(nativeContext))) {
      const nativeContextOrBackupNativeContext = nativeContext.state === "closed" && nativeOfflineAudioContextConstructor2 !== null && isNativeOfflineAudioContext2(nativeContext) ? new nativeOfflineAudioContextConstructor2(1, 1, nativeContext.sampleRate) : nativeContext;
...
const createDelayNodeConstructor = (audioNodeConstructor2, createAudioParam2, createDelayNodeRenderer2, createNativeDelayNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class DelayNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$a) {
      const nativeContext = getNativeContext2(context2);
      ...
      this._delayTime = createAudioParam2(this, isOffline, nativeDelayNode.delayTime, mergedOptions.maxDelayTime, 0);
    }
    get delayTime() {
...
const createDynamicsCompressorNodeConstructor = (audioNodeConstructor2, createAudioParam2, createDynamicsCompressorNodeRenderer2, createNativeDynamicsCompressorNode2, createNotSupportedError2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class DynamicsCompressorNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$9) {
      const nativeContext = getNativeContext2(context2);
      ...
      this._attack = createAudioParam2(this, isOffline, nativeDynamicsCompressorNode.attack, 1, 0);
      this._knee = createAudioParam2(this, isOffline, nativeDynamicsCompressorNode.knee, 40, 0);
      this._nativeDynamicsCompressorNode = nativeDynamicsCompressorNode;
      this._ratio = createAudioParam2(this, isOffline, nativeDynamicsCompressorNode.ratio, 20, 1);
      this._release = createAudioParam2(this, isOffline, nativeDynamicsCompressorNode.release, 1, 0);
      this._threshold = createAudioParam2(this, isOffline, nativeDynamicsCompressorNode.threshold, 0, -100);
    }
    get attack() {
      return this._attack;
    }
...
const createGainNodeConstructor = (audioNodeConstructor2, createAudioParam2, createGainNodeRenderer2, createNativeGainNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class GainNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$8) {
      const nativeContext = getNativeContext2(context2);
...
const createGetBackupNativeContext = (isNativeOfflineAudioContext2, nativeAudioContextConstructor2, nativeOfflineAudioContextConstructor2) => {
  return (nativeContext) => {
    if (nativeContext.state === "closed" && nativeAudioContextConstructor2 !== null && nativeAudioContextConstructor2.name !== "webkitAudioContext") {
      if (isNativeOfflineAudioContext2(nativeContext)) {
        const backupNativeContext = BACKUP_NATIVE_CONTEXT_STORE.get(nativeContext);
        if (backupNativeContext !== void 0) {
          return backupNativeContext;
        }
        if (nativeOfflineAudioContextConstructor2 !== null) {
          const bckpNtveCntxt = new nativeOfflineAudioContextConstructor2(1, 1, 44100);
        ...
        const bckpNtveCntxt = new nativeAudioContextConstructor2();
        BACKUP_NATIVE_CONTEXT_STORE.set(nativeContext, bckpNtveCntxt);
        return bckpNtveCntxt;
      }
    }
...
const createIIRFilterNodeConstructor = (audioNodeConstructor2, createNativeIIRFilterNode2, createIIRFilterNodeRenderer2, getNativeContext2, isNativeOfflineAudioContext2) => {
...
const createIIRFilterNodeRendererFactory = (createNativeAudioBufferSourceNode2, createNativeAudioNode2, getNativeAudioNode2, nativeOfflineAudioContextConstructor2, renderInputsOfAudioNode2, renderNativeOfflineAudioContext2) => {
  return (feedback, feedforward) => {
    ...
    const createAudioNode = async (proxy, nativeOfflineAudioContext, trace) => {
      ...
      if (nativeOfflineAudioContext.createIIRFilter === void 0) {
        ...
        nativeIIRFilterNode = createNativeAudioNode2(nativeOfflineAudioContext, (ntvCntxt) => {
...
const createMediaElementAudioSourceNodeConstructor = (audioNodeConstructor2, createNativeMediaElementAudioSourceNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class MediaElementAudioSourceNode extends audioNodeConstructor2 {
    ...
    get mediaElement() {
      return this._nativeMediaElementAudioSourceNode.mediaElement === void 0 ? this._mediaElement : this._nativeMediaElementAudioSourceNode.mediaElement;
    }
  };
};
...
const createMediaStreamAudioDestinationNodeConstructor = (audioNodeConstructor2, createNativeMediaStreamAudioDestinationNode2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class MediaStreamAudioDestinationNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$6) {
      const nativeContext = getNativeContext2(context2);
      if (isNativeOfflineAudioContext2(nativeContext)) {
        throw new TypeError();
      }
...
const createNativeAnalyserNodeFactory = (cacheTestResult2, createIndexSizeError2, createNativeAudioNode2) => {
  return (nativeContext, options) => {
    const nativeAnalyserNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createAnalyser());
...
const wrapAudioBufferSourceNodeStartMethodDurationParameter = (nativeAudioScheduledSourceNode, nativeContext) => {
  ...
  nativeAudioScheduledSourceNode.start = /* @__PURE__ */ ((start2, stop) => {
    return (when = 0, offset = 0, duration = Number.POSITIVE_INFINITY) => {
      start2.call(nativeAudioScheduledSourceNode, when, offset);
...
const createNativeAudioBufferSourceNodeFactory = (addSilentConnection2, cacheTestResult2, createNativeAudioNode2, testAudioBufferSourceNodeStartMethodConsecutiveCallsSupport, testAudioBufferSourceNodeStartMethodDurationParameterSupport, testAudioBufferSourceNodeStartMethodOffsetClampingSupport, testAudioBufferSourceNodeStopMethodNullifiedBufferSupport, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport2, testAudioScheduledSourceNodeStopMethodConsecutiveCallsSupport2, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport2, wrapAudioBufferSourceNodeStartMethodOffsetClampling, wrapAudioBufferSourceNodeStopMethodNullifiedBuffer, wrapAudioScheduledSourceNodeStopMethodConsecutiveCalls2) => {
  return (nativeContext, options) => {
    ...
    if (!cacheTestResult2(testAudioBufferSourceNodeStartMethodConsecutiveCallsSupport, () => testAudioBufferSourceNodeStartMethodConsecutiveCallsSupport(nativeContext))) {
      wrapAudioBufferSourceNodeStartMethodConsecutiveCalls(nativeAudioBufferSourceNode);
    }
    if (!cacheTestResult2(testAudioBufferSourceNodeStartMethodDurationParameterSupport, testAudioBufferSourceNodeStartMethodDurationParameterSupport)) {
      wrapAudioBufferSourceNodeStartMethodDurationParameter(nativeAudioBufferSourceNode, nativeContext);
    }
    if (!cacheTestResult2(testAudioBufferSourceNodeStartMethodOffsetClampingSupport, () => testAudioBufferSourceNodeStartMethodOffsetClampingSupport(nativeContext))) {
      wrapAudioBufferSourceNodeStartMethodOffsetClampling(nativeAudioBufferSourceNode);
    }
    if (!cacheTestResult2(testAudioBufferSourceNodeStopMethodNullifiedBufferSupport, () => testAudioBufferSourceNodeStopMethodNullifiedBufferSupport(nativeContext))) {
...
const createNativeAudioNodeFactory = (getBackupNativeContext2) => {
...
const createNativeAudioWorkletNodeFactory = (createInvalidStateError2, createNativeAudioNode2, createNativeAudioWorkletNodeFaker2, createNativeGainNode2, createNotSupportedError2, monitorConnections2) => {
  return (nativeContext, baseLatency, nativeAudioWorkletNodeConstructor2, name, processorConstructor, options) => {
    if (nativeAudioWorkletNodeConstructor2 !== null) {
      try {
        const nativeAudioWorkletNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => {
          return new nativeAudioWorkletNodeConstructor2(ntvCntxt, name, options);
        });
            ...
            if (args[0] === "processorerror") {
              ...
              if (unpatchedEventListener !== null) {
                ...
                if (patchedEventListener !== void 0) {
                  ...
                  args[1] = (event) => {
                    unpatchedEventListener(new ErrorEvent(args[0], { ...event, error: new Error(
                      /* @todo */
                    ) }));
                  };
        ...
        if (options.numberOfOutputs !== 0) {
          ...
          nativeAudioWorkletNode.connect(nativeGainNode).connect(nativeGainNode.context.destination);
...
const createNativeAudioWorkletNodeFakerFactory = (auxiliaryGainNodeStore2, connectMultipleOutputs2, createIndexSizeError2, createInvalidStateError2, createNativeChannelMergerNode2, createNativeChannelSplitterNode2, createNativeConstantSourceNode2, createNativeGainNode2, createNativeScriptProcessorNode2, createNotSupportedError2, disconnectMultipleOutputs2, exposeCurrentFrameAndCurrentTime2, monitorConnections2) => {
  return (nativeContext, baseLatency, processorConstructor, options) => {
    if (options.numberOfInputs === 0 && options.numberOfOutputs === 0) {
      throw createNotSupportedError2();
    }
    if (options.outputChannelCount !== void 0) {
    ...
    scriptProcessorNode.onaudioprocess = ({ inputBuffer, outputBuffer }) => {
      if (audioWorkletProcessor !== null) {
        for (let i = 0; i < bufferSize; i += 128) {
          ...
          try {
            const potentiallyEmptyInputs = inputs.map((input, index) => {
              const auxiliaryGainNodes = auxiliaryGainNodeStore2.get(nativeAudioWorkletNodeFaker);
              if (auxiliaryGainNodes === void 0 || auxiliaryGainNodes.get(index) === void 0) {
                return [];
              }
              return input;
            });
    ...
    const connectFakeGraph = () => scriptProcessorNode.connect(nativeGainNode).connect(nativeGainNode.context.destination);
...
const createNativeBiquadFilterNodeFactory = (createNativeAudioNode2) => {
  return (nativeContext, options) => {
    const nativeBiquadFilterNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createBiquadFilter());
...
const createNativeChannelMergerNodeFactory = (createNativeAudioNode2, wrapChannelMergerNode2) => {
  return (nativeContext, options) => {
    const nativeChannelMergerNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => {
...
const createNativeChannelSplitterNodeFactory = (createNativeAudioNode2) => {
  return (nativeContext, options) => {
    const nativeChannelSplitterNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => {
...
const createNativeConstantSourceNodeFactory = (addSilentConnection2, cacheTestResult2, createNativeAudioNode2, createNativeConstantSourceNodeFaker2, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport2, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport2) => {
  return (nativeContext, options) => {
    if (nativeContext.createConstantSource === void 0) {
      return createNativeConstantSourceNodeFaker2(nativeContext, options);
    }
    const nativeConstantSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => {
...
const createNativeConvolverNodeFactory = (createNativeAudioNode2, createNativeConvolverNodeFaker2, createNotSupportedError2, overwriteAccessors2) => {
  return (nativeContext, options) => {
    const nativeConvolverNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createConvolver());
    try {
      nativeConvolverNode.channelCount = 1;
    } catch (err) {
      return createNativeConvolverNodeFaker2(nativeContext, options);
    }
...
const createNativeConvolverNodeFakerFactory = (createNativeAudioNode2, createNativeGainNode2, monitorConnections2) => {
  return (nativeContext, { buffer, channelCount, channelCountMode, channelInterpretation, disableNormalization }) => {
    const convolverNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createConvolver());
    ...
    const gainNode = createNativeGainNode2(nativeContext, { channelCount, channelCountMode, channelInterpretation, gain: 1 });
    ...
    return monitorConnections2(interceptConnections(nativeConvolverNodeFaker, gainNode), whenConnected, whenDisconnected);
  };
};
const createNativeDelayNodeFactory = (createNativeAudioNode2) => {
  return (nativeContext, options) => {
    const nativeDelayNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createDelay(options.maxDelayTime));
    assignNativeAudioNodeOptions(nativeDelayNode, options);
    assignNativeAudioNodeAudioParamValue(nativeDelayNode, options, "delayTime");
    return nativeDelayNode;
  };
};
const createNativeDynamicsCompressorNodeFactory = (createNativeAudioNode2, createNotSupportedError2) => {
  return (nativeContext, options) => {
    const nativeDynamicsCompressorNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createDynamicsCompressor());
...
const createNativeGainNodeFactory = (createNativeAudioNode2) => {
  return (nativeContext, options) => {
    const nativeGainNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createGain());
    assignNativeAudioNodeOptions(nativeGainNode, options);
    assignNativeAudioNodeAudioParamValue(nativeGainNode, options, "gain");
    return nativeGainNode;
  };
};
const createNativeIIRFilterNodeFactory = (createNativeAudioNode2, createNativeIIRFilterNodeFaker2) => {
  return (nativeContext, baseLatency, options) => {
    if (nativeContext.createIIRFilter === void 0) {
      return createNativeIIRFilterNodeFaker2(nativeContext, baseLatency, options);
    }
    const nativeIIRFilterNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => {
...
const createNativeMediaElementAudioSourceNodeFactory = (createNativeAudioNode2) => {
  return (nativeAudioContext, options) => createNativeAudioNode2(nativeAudioContext, (ntvDCntxt) => {
    return ntvDCntxt.createMediaElementSource(options.mediaElement);
  });
};
const createNativeMediaStreamAudioDestinationNodeFactory = (createNativeAudioNode2, createNotSupportedError2) => {
  return (nativeAudioContext, options) => {
    if (nativeAudioContext.createMediaStreamDestination === void 0) {
      throw createNotSupportedError2();
    }
    const nativeMediaStreamAudioDestinationNode = createNativeAudioNode2(nativeAudioContext, (ntvDCntxt) => {
...
const createNativeMediaStreamAudioSourceNodeFactory = (createNativeAudioNode2) => {
  return (nativeAudioContext, { mediaStream }) => {
    const audioStreamTracks = mediaStream.getAudioTracks();
    const nativeMediaStreamAudioSourceNode = createNativeAudioNode2(nativeAudioContext, (ntvDCntxt) => {
...
const createNativeMediaStreamTrackAudioSourceNodeFactory = (createInvalidStateError2, createNativeAudioNode2, isNativeOfflineAudioContext2) => {
  return (nativeAudioContext, { mediaStreamTrack }) => {
    if (typeof nativeAudioContext.createMediaStreamTrackSource === "function") {
      return createNativeAudioNode2(nativeAudioContext, (ntvDCntxt) => ntvDCntxt.createMediaStreamTrackSource(mediaStreamTrack));
    }
    return createNativeAudioNode2(nativeAudioContext, (ntvDCntxt) => {
      const mediaStream = new MediaStream([mediaStreamTrack]);
      const nativeMediaStreamAudioSourceNode = ntvDCntxt.createMediaStreamSource(mediaStream);
      if (mediaStreamTrack.kind !== "audio") {
        throw createInvalidStateError2();
      }
      if (isNativeOfflineAudioContext2(ntvDCntxt)) {
        throw new TypeError();
      }
      return nativeMediaStreamAudioSourceNode;
    });
...
const createNativeOscillatorNodeFactory = (addSilentConnection2, cacheTestResult2, createNativeAudioNode2, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport2, testAudioScheduledSourceNodeStopMethodConsecutiveCallsSupport2, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport2, wrapAudioScheduledSourceNodeStopMethodConsecutiveCalls2) => {
  return (nativeContext, options) => {
    const nativeOscillatorNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createOscillator());
...
const createNativePannerNodeFactory = (createNativeAudioNode2, createNativePannerNodeFaker2) => {
  return (nativeContext, options) => {
    const nativePannerNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createPanner());
...
const createNativePannerNodeFakerFactory = (connectNativeAudioNodeToNativeAudioNode2, createInvalidStateError2, createNativeAudioNode2, createNativeChannelMergerNode2, createNativeGainNode2, createNativeScriptProcessorNode2, createNativeWaveShaperNode2, createNotSupportedError2, disconnectNativeAudioNodeFromNativeAudioNode2, monitorConnections2) => {
  return (nativeContext, { coneInnerAngle, coneOuterAngle, coneOuterGain, distanceModel, maxDistance, orientationX, orientationY, orientationZ, panningModel, positionX, positionY, positionZ, refDistance, rolloffFactor, ...audioNodeOptions }) => {
    const pannerNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createPanner());
...
const createNativePeriodicWaveFactory = (getBackupNativeContext2) => {
...
const createNativeScriptProcessorNodeFactory = (createNativeAudioNode2) => {
  return (nativeContext, bufferSize, numberOfInputChannels, numberOfOutputChannels) => {
    return createNativeAudioNode2(nativeContext, (ntvCntxt) => {
      return ntvCntxt.createScriptProcessor(bufferSize, numberOfInputChannels, numberOfOutputChannels);
    });
  };
};
const createNativeStereoPannerNodeFactory = (createNativeAudioNode2, createNativeStereoPannerNodeFaker, createNotSupportedError2) => {
  return (nativeContext, options) => createNativeAudioNode2(nativeContext, (ntvCntxt) => {
...
const createNativeWaveShaperNodeFactory = (createConnectedNativeAudioBufferSourceNode2, createInvalidStateError2, createNativeAudioNode2, createNativeWaveShaperNodeFaker2, isDCCurve2, monitorConnections2, overwriteAccessors2) => {
  return (nativeContext, options) => {
    const nativeWaveShaperNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createWaveShaper());
    try {
...
const createNativeWaveShaperNodeFakerFactory = (createConnectedNativeAudioBufferSourceNode2, createInvalidStateError2, createNativeAudioNode2, createNativeGainNode2, isDCCurve2, monitorConnections2) => {
  return (nativeContext, { curve, oversample, ...audioNodeOptions }) => {
    const negativeWaveShaperNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createWaveShaper());
    const positiveWaveShaperNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createWaveShaper());
...
const createOfflineAudioContextConstructor = (baseAudioContextConstructor2, cacheTestResult2, createInvalidStateError2, createNativeOfflineAudioContext2, startRendering2) => {
  return class OfflineAudioContext extends baseAudioContextConstructor2 {
    ...
    startRendering() {
      ...
      this._state = "running";
      return startRendering2(this.destination, this._nativeOfflineAudioContext).then((audioBuffer) => {
        this._state = null;
        return audioBuffer;
      }).catch((err) => {
        this._state = null;
...
const createOscillatorNodeConstructor = (audioNodeConstructor2, createAudioParam2, createInvalidStateError2, createNativeOscillatorNode2, createOscillatorNodeRenderer2, getNativeContext2, isNativeOfflineAudioContext2, wrapEventListener2) => {
  return class OscillatorNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$4) {
      const nativeContext = getNativeContext2(context2);
...
const createPannerNodeConstructor = (audioNodeConstructor2, createAudioParam2, createNativePannerNode2, createPannerNodeRenderer2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class PannerNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$3) {
      const nativeContext = getNativeContext2(context2);
...
const createPeriodicWaveConstructor = (createNativePeriodicWave2, getNativeContext2, periodicWaveStore) => {
...
const createStereoPannerNodeConstructor = (audioNodeConstructor2, createAudioParam2, createNativeStereoPannerNode2, createStereoPannerNodeRenderer2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class StereoPannerNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS$1) {
      const nativeContext = getNativeContext2(context2);
      ...
      this._pan = createAudioParam2(this, isOffline, nativeStereoPannerNode.pan, 1, -1);
    }
    get pan() {
      return this._pan;
    }
...
const createTestAudioBufferCopyChannelMethodsSubarraySupport = (nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return false;
    }
...
const createTestAudioBufferSourceNodeStartMethodConsecutiveCallsSupport = (createNativeAudioNode2) => {
  return (nativeContext) => {
    const nativeAudioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createBufferSource());
    nativeAudioBufferSourceNode.start();
    try {
...
const createTestAudioBufferSourceNodeStartMethodDurationParameterSupport = (nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
...
const createTestAudioBufferSourceNodeStartMethodOffsetClampingSupport = (createNativeAudioNode2) => {
  return (nativeContext) => {
    const nativeAudioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createBufferSource());
...
const createTestAudioBufferSourceNodeStopMethodNullifiedBufferSupport = (createNativeAudioNode2) => {
  return (nativeContext) => {
    const nativeAudioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createBufferSource());
    nativeAudioBufferSourceNode.start();
    try {
...
const createTestAudioContextCloseMethodSupport = (nativeAudioContextConstructor2) => {
  return () => {
    if (nativeAudioContextConstructor2 === null) {
      return false;
    }
...
const createTestAudioContextDecodeAudioDataMethodTypeErrorSupport = (nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return Promise.resolve(false);
    }
...
const createTestAudioContextOptionsSupport = (nativeAudioContextConstructor2) => {
  return () => {
    if (nativeAudioContextConstructor2 === null) {
      return false;
    }
...
const createTestAudioNodeConnectMethodSupport = (nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return false;
    }
...
const createTestAudioScheduledSourceNodeStartMethodNegativeParametersSupport = (createNativeAudioNode2) => {
  return (nativeContext) => {
    const nativeAudioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createOscillator());
    try {
...
const createTestAudioScheduledSourceNodeStopMethodConsecutiveCallsSupport = (createNativeAudioNode2) => {
  return (nativeContext) => {
    const nativeAudioBuffer = nativeContext.createBuffer(1, 1, 44100);
    const nativeAudioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createBufferSource());
    nativeAudioBufferSourceNode.buffer = nativeAudioBuffer;
...
const createTestAudioScheduledSourceNodeStopMethodNegativeParametersSupport = (createNativeAudioNode2) => {
  return (nativeContext) => {
    const nativeAudioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createOscillator());
    try {
...
const createTestAudioWorkletProcessorNoOutputsSupport = (nativeAudioWorkletNodeConstructor2, nativeOfflineAudioContextConstructor2) => {
  return async () => {
    if (nativeAudioWorkletNodeConstructor2 === null) {
      return true;
    }
    ...
    const offlineAudioContext = new nativeOfflineAudioContextConstructor2(1, 128, 3200);
    const url = URL.createObjectURL(blob);
...
const createTestChannelMergerNodeChannelCountSupport = (createNativeAudioNode2, nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return false;
    }
    const offlineAudioContext = new nativeOfflineAudioContextConstructor2(1, 1, 44100);
    const nativeChannelMergerNode = createNativeAudioNode2(offlineAudioContext, (ntvCntxt) => ntvCntxt.createChannelMerger());
...
const createTestConstantSourceNodeAccurateSchedulingSupport = (createNativeAudioNode2, nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return false;
    }
    ...
    const nativeConstantSourceNode = createNativeAudioNode2(nativeOfflineAudioContext, (ntvCntxt) => ntvCntxt.createConstantSource());
    return nativeConstantSourceNode.offset.maxValue !== Number.POSITIVE_INFINITY;
  };
};
const createTestConvolverNodeBufferReassignabilitySupport = (nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return false;
    }
...
const createTestIsSecureContextSupport = (window2) => {
  return () => window2 !== null && window2.hasOwnProperty("isSecureContext");
};
const createTestMediaStreamAudioSourceNodeMediaStreamWithoutAudioTrackSupport = (nativeAudioContextConstructor2) => {
  return () => {
    if (nativeAudioContextConstructor2 === null) {
      return false;
    }
...
const createTestStereoPannerNodeDefaultValueSupport = (nativeOfflineAudioContextConstructor2) => {
  return () => {
    if (nativeOfflineAudioContextConstructor2 === null) {
      return Promise.resolve(false);
    }
...
const createWaveShaperNodeConstructor = (audioNodeConstructor2, createInvalidStateError2, createNativeWaveShaperNode2, createWaveShaperNodeRenderer2, getNativeContext2, isNativeOfflineAudioContext2) => {
  return class WaveShaperNode extends audioNodeConstructor2 {
    constructor(context2, options = DEFAULT_OPTIONS) {
      const nativeContext = getNativeContext2(context2);
...
const createWrapAudioScheduledSourceNodeStopMethodConsecutiveCalls = (createNativeAudioNode2) => {
...
const createWrapChannelMergerNode = (createInvalidStateError2, createNativeAudioNode2, monitorConnectionsFunction) => {
  return (nativeContext, channelMergerNode) => {
    ...
    const audioBufferSourceNode = createNativeAudioNode2(nativeContext, (ntvCntxt) => ntvCntxt.createBufferSource());
    const whenConnected = () => {
...
const auxiliaryGainNodeStore = /* @__PURE__ */ new WeakMap();
...
const periodicWaveConstructor = createPeriodicWaveConstructor(createNativePeriodicWave, getNativeContext, /* @__PURE__ */ new WeakSet());
...
const decodeAudioData = createDecodeAudioData(audioBufferStore, cacheTestResult, createDataCloneError, createEncodingError, /* @__PURE__ */ new WeakSet(), getNativeContext, isNativeContext, isNativeOfflineAudioContext, nativeOfflineAudioContextConstructor, testAudioBufferCopyChannelMethodsOutOfBoundsSupport, testPromiseSupport, wrapAudioBufferCopyChannelMethods, wrapAudioBufferCopyChannelMethodsOutOfBounds);
...
class PolySynth extends Instrument {
   ...
   */
  set(options) {
    const sanitizedOptions2 = omitFromObject(options, ["onsilence", "context"]);
    this.options = deepMerge(this.options, sanitizedOptions2);
    this._voices.forEach((voice) => voice.set(sanitizedOptions2));
    this._dummyVoice.set(sanitizedOptions2);
    return this;
  }
  get() {
...
const combFilterDelayTimes = [1687 / 25e3, 1601 / 25e3, 2053 / 25e3, 2251 / 25e3];
...
let Listener$1 = class Listener extends ToneAudioNode {
  constructor() {
    super(...arguments);
    this.name = "Listener";
...
onContextInit((context2) => {
  context2.listener = new Listener$1({ context: context2 });
});
onContextClose((context2) => {
...
const Destination2 = getContext().destination;
const Master = getContext().destination;
function getDestination() {
  return getContext().destination;
}
const Listener2 = getContext().listener;
