...
class VintageDelayEffect extends ToneAudioNode {
  name = "VintageDelay";
  input;
  output;
  dryGain;
  ...
  constructor(options = {}) {
    ...
    this._cutoff = options.cutoff ?? 3e3;
  ...
  async _initWorklet() {
    try {
      ...
      console.warn("[VintageDelay] Worklet init failed:", err);
    }
  }
