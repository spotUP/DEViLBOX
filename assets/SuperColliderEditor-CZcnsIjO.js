...
import { e as useInstrumentStore, $ as getToneEngine, am as __vitePreload } from "./main-BbV5VyEH.js";
import { j as jsxDevRuntimeExports } from "./client-DHYdgbIN.js";
import { a as reactExports, R as React, a7 as RefreshCw, a9 as BookOpen, h as ChevronDown, U as Upload, D as Download, P as Plus, X, aw as Copy, a6 as Loader, s as Play, a8 as CircleAlert, aB as CircleCheckBig } from "./vendor-ui-AJ7AT9BN.js";
...
const SC_KEYWORDS = /* @__PURE__ */ new Set([
  "var",
  "arg",
  "if",
  "while",
...
const scStreamLanguage = StreamLanguage.define({
  name: "supercollider",
...
const scHighlightStyle = HighlightStyle.define([
...
function parseColor(src) {
  ...
  if (m) {
    return { r: parseFloat(m[1]), g: parseFloat(m[2]), b: parseFloat(m[3]), a: m[4] ? parseFloat(m[4]) : void 0 };
  }
  const named = {
    white: { r: 1, g: 1, b: 1 },
    black: { r: 0, g: 0, b: 0 },
...
function parseAction(actionBody) {
...
function extractActionBody(src, startIdx) {
  const actionMatch = src.slice(startIdx).match(/\.action_\s*\(\s*\{/);
  if (!actionMatch || actionMatch.index === void 0) return null;
...
function parsePropertyChain(chainSrc) {
  const props = {};
...
function extractRoutinePattern(source, variables) {
  if (!/Routine\s*\.\s*new\s*\(/.test(source)) return void 0;
  const pitches = variables["pitches"] ?? variables["defaultPitches"];
  if (!Array.isArray(pitches) || pitches.length === 0) return void 0;
  let gates;
  ...
  const bpm = typeof variables["bpm"] === "number" ? variables["bpm"] : void 0;
  const rootNote = typeof variables["root"] === "number" ? variables["root"] : void 0;
  return {
...
function scColorToCSS(c, fallback) {
  if (!c) return fallback ?? "transparent";
  const r = Math.round(c.r * 255);
  const g = Math.round(c.g * 255);
  const b = Math.round(c.b * 255);
  return c.a !== void 0 ? `rgba(${r},${g},${b},${c.a})` : `rgb(${r},${g},${b})`;
}
function buildTransformFn(transform) {
  try {
...
const SCStaticText = ({ widget }) => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { style, children: text }, void 0, false, {
    fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
    lineNumber: 86,
    columnNumber: 10
  }, void 0);
};
const SCNumberBox = ({ widget, onParamChange }) => {
  var _a2, _b;
  ...
  const style = {
    width: ((_a2 = widget.rect) == null ? void 0 : _a2.w) ?? 50,
    height: ((_b = widget.rect) == null ? void 0 : _b.h) ?? 18,
    fontSize: 11,
...
const SCSlider = ({ widget, onParamChange }) => {
  var _a2, _b, _c;
  ...
  const step = widget.properties.step ?? 5e-3;
  ...
  const w = ((_a2 = widget.rect) == null ? void 0 : _a2.w) ?? 80;
  const h = ((_b = widget.rect) == null ? void 0 : _b.h) ?? 20;
  const style = {
    ...
    borderRadius: 3,
    cursor: "pointer",
    ...isVertical ? { writingMode: "vertical-lr", direction: "rtl" } : {}
  };
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    "input",
    {
      ...
      style,
      title: ((_c = widget.action) == null ? void 0 : _c.param) ?? widget.varName ?? ""
    },
    void 0,
    false,
    {
...
const SCButton = ({ widget, onParamChange }) => {
  var _a2, _b;
  const states = widget.properties.states ?? [{ label: "?" }];
  const [stateIdx, setStateIdx] = reactExports.useState(0);
  ...
  const w = ((_a2 = widget.rect) == null ? void 0 : _a2.w) ?? 45;
  const h = ((_b = widget.rect) == null ? void 0 : _b.h) ?? 22;
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    "button",
    {
      onClick: handleClick,
...
const WidgetRenderer = (props) => {
  switch (props.widget.type) {
    case "staticText":
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SCStaticText, { ...props }, void 0, false, {
        fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
        lineNumber: 226,
        columnNumber: 31
      }, void 0);
    case "numberBox":
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SCNumberBox, { ...props }, void 0, false, {
        fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
        lineNumber: 227,
        columnNumber: 30
      }, void 0);
    case "slider":
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SCSlider, { ...props }, void 0, false, {
        fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
        lineNumber: 228,
        columnNumber: 27
      }, void 0);
    case "button":
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SCButton, { ...props }, void 0, false, {
        fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
        lineNumber: 229,
        columnNumber: 27
      }, void 0);
...
const RoutinePatternView = ({ routine, onGeneratePattern }) => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: {
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: { display: "flex", gap: 2, alignItems: "flex-end", height: 60 }, children: pitches.map((p, i) => {
      const midi = root + p;
      const barHeight = noteRange > 0 ? 10 + (midi - minNote) / noteRange * 44 : 30;
      ...
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "div",
        {
          ...
          style: {
            ...
            height: barHeight,
            borderRadius: 2,
            background: isRest ? "rgba(255,255,255,0.05)" : gate < 1 ? `rgba(80,160,255,${0.3 + gate * 0.5})` : "rgb(80,160,255)",
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: { display: "flex", gap: 2, marginTop: 2 }, children: pitches.map((_p, i) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: {
      flex: 1,
      minWidth: 6,
      maxWidth: 24,
      fontSize: 7,
    ...
    onGeneratePattern && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
      "button",
      {
        ...
        children: "Generate Tracker Pattern"
      },
      void 0,
      false,
      {
...
function groupWidgetsIntoRows(widgets) {
  ...
  let currentLabels = [];
  let currentControls = [];
  const sorted = [...widgets].filter(
    (w) => w.type !== "window" && w.type !== "compositeView" && // Skip StaticText with no label (dynamic expressions stripped by parser)
...
const SCGuiRenderer = ({
  ...
  var _a2;
  const rows = reactExports.useMemo(() => groupWidgetsIntoRows(gui.widgets), [gui.widgets]);
  const title = ((_a2 = gui.window) == null ? void 0 : _a2.label) ?? "SC GUI";
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    "div",
    {
      ...
      children: [
        ...
        rows.map((row, i) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
          row.labels.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, alignItems: "center" }, children: row.labels.map((w, j) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(WidgetRenderer, { widget: w, onParamChange }, `l-${i}-${j}`, false, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
            lineNumber: 440,
            columnNumber: 17
          }, void 0)) }, void 0, false, {
          ...
          row.controls.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, alignItems: "center" }, children: row.controls.map((w, j) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(WidgetRenderer, { widget: w, onParamChange }, `c-${i}-${j}`, false, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
            lineNumber: 448,
            columnNumber: 17
          }, void 0)) }, void 0, false, {
        ...
        gui.routine && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(RoutinePatternView, { routine: gui.routine, onGeneratePattern }, void 0, false, {
          fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SCGuiRenderer.tsx",
          lineNumber: 456,
          columnNumber: 23
        }, void 0)
...
const SuperColliderEditor = ({ config, onChange }) => {
  ...
  const handleCompileRef = reactExports.useRef(async () => {
  });
  ...
  const [presetCategory, setPresetCategory] = reactExports.useState("All");
  const [presetSearch, setPresetSearch] = reactExports.useState("");
  const [scTab, setScTab] = reactExports.useState("script");
  const presetSearchRef = reactExports.useRef(null);
  const progressRef = reactExports.useRef(0);
  const progressIntervalRef = reactExports.useRef(null);
  const guiResult = reactExports.useMemo(() => parseSCGui(config.source), [config.source]);
  ...
  const finishProgress = reactExports.useCallback((success) => {
  ...
  const handleCompile = reactExports.useCallback(async () => {
    var _a2;
    setStatus({ state: "compiling" });
    startProgress();
    const source = ((_a2 = viewRef.current) == null ? void 0 : _a2.state.doc.toString()) ?? configRef.current.source;
    try {
      ...
      if (data.success) {
        const newParams = data.params.map((p) => ({
          name: p.name,
          default: p.default,
          min: p.min,
          max: p.max,
      ...
      const rawOutput = isConnectionError ? `Could not connect to the compile server:
  ${API_URL}/sc/compile

Start the backend with:
  cd server && npm run dev

Or set VITE_API_URL in your .env.local to point at a running instance.` : void 0;
  ...
  const handleParamChange = reactExports.useCallback((name2, value) => {
    onChangeRef.current({
      ...configRef.current,
      params: configRef.current.params.map(
        (p) => p.name === name2 ? { ...p, value } : p
      )
    });
  }, []);
  const handleParamRangeChange = reactExports.useCallback((name2, field, raw) => {
    const num = parseFloat(raw);
    if (!isFinite(num)) return;
    onChangeRef.current({
      ...configRef.current,
      params: configRef.current.params.map((p) => {
        if (p.name !== name2) return p;
  ...
  const handleAddParam = reactExports.useCallback(() => {
  ...
  const handleRemoveParam = reactExports.useCallback((name2) => {
    onChangeRef.current({
      ...configRef.current,
      params: configRef.current.params.filter((p) => p.name !== name2)
    });
  }, []);
  const handleGuiParamChange = reactExports.useCallback((param, value) => {
    const cfg = configRef.current;
  ...
  const handleGeneratePattern = reactExports.useCallback((routine) => {
    __vitePreload(async () => {
      const { useTrackerStore } = await import("./main-BbV5VyEH.js").then((n) => n.j8);
      return { useTrackerStore };
    }, true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0).then(({ useTrackerStore }) => {
      ...
      __vitePreload(async () => {
        const { useUIStore } = await import("./main-BbV5VyEH.js").then((n) => n.iQ);
        return { useUIStore };
      }, true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0).then(({ useUIStore }) => {
  ...
  const handleImport = reactExports.useCallback((e) => {
    var _a2;
    ...
    reader.onload = (evt) => {
      var _a3;
      try {
        const preset = JSON.parse((_a3 = evt.target) == null ? void 0 : _a3.result);
  ...
  const handleSaveAsNewInstrument = reactExports.useCallback(() => {
    const cfg = configRef.current;
    if (!cfg.binary) {
      alert("Compile the SynthDef first before saving as a new instrument.");
      return;
    }
    const name2 = (cfg.synthDefName || "SC Synth").slice(0, 22);
    const newId = createInstrument({
      name: name2,
      synthType: "SuperCollider",
      superCollider: {
        synthDefName: cfg.synthDefName,
        source: cfg.source,
        binary: cfg.binary,
  ...
  const handleLoadPreset = reactExports.useCallback(async (preset) => {
    onChangeRef.current({
      ...configRef.current,
      source: preset.source,
    ...
    try {
      ...
      setStatus({
        ...
        rawOutput: isConnectionError ? `Could not connect to the compile server:
  ${API_URL}/sc/compile

Start the backend with:
  cd server && npm run dev` : void 0
      });
    }
  }, [startProgress, finishProgress]);
  const filteredPresets = reactExports.useMemo(() => {
    ...
    if (presetSearch.trim()) {
      ...
      list = list.filter(
        (p) => p.name.toLowerCase().includes(q) || p.credit.toLowerCase().includes(q) || p.category.toLowerCase().includes(q) || p.tags.some((t2) => t2.toLowerCase().includes(q))
      );
    }
    return list;
  ...
  const renderStatus = () => {
    switch (status.state) {
      case "idle":
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-text-muted text-xs", children: config.binary ? `\\${config.synthDefName}` : "⚠ Not compiled" }, void 0, false, {
          fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
          lineNumber: 618,
          columnNumber: 11
        }, void 0);
      case "compiling":
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "flex items-center gap-1.5 text-xs text-text-secondary", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Loader, { size: 12, className: "animate-spin" }, void 0, false, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
            lineNumber: 625,
            columnNumber: 13
          }, void 0),
      ...
      case "compiled":
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "flex items-center gap-1.5 text-xs text-accent-success", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(CircleCheckBig, { size: 12 }, void 0, false, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
            lineNumber: 632,
            columnNumber: 13
          }, void 0),
      ...
      case "error": {
        const errorText = (status.line !== void 0 ? `Line ${status.line}: ` : "") + status.message;
        const copyText = status.rawOutput ? `${errorText}

${status.rawOutput}` : errorText;
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "flex items-center gap-1.5 text-xs text-accent-error min-w-0", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(CircleAlert, { size: 12, className: "shrink-0" }, void 0, false, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
            lineNumber: 641,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "truncate select-text cursor-text", title: errorText, children: errorText }, void 0, false, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
            lineNumber: 642,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Copy, { size: 11 }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 648,
                columnNumber: 15
              }, void 0)
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col h-full bg-dark-bg rounded-lg border border-dark-border overflow-hidden", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between px-3 py-2 bg-dark-bgSecondary border-b border-dark-border shrink-0", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-0.5", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            onClick: () => setScTab("script"),
            className: `px-2.5 py-1 rounded text-xs font-semibold transition-colors ${scTab === "script" ? "bg-accent-primary/15 text-accent-primary" : "text-text-muted hover:text-text-secondary"}`,
            children: "Script"
          },
          void 0,
          false,
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            ...
            className: `px-2.5 py-1 rounded text-xs font-semibold transition-colors ${scTab === "controls" ? "bg-accent-primary/15 text-accent-primary" : "text-text-muted hover:text-text-secondary"}`,
            children: "Controls"
          },
          void 0,
          false,
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-2", children: [
        config.synthDefName && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs text-text-muted font-mono mr-2", children: [
          "\\",
          config.synthDefName
        ] }, void 0, true, {
          fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            ...
            className: [
              ...
              status.state === "compiling" ? "text-text-muted cursor-not-allowed" : "text-text-secondary hover:text-text-primary hover:bg-dark-bgTertiary"
            ].join(" "),
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(RefreshCw, { size: 11, className: status.state === "compiling" ? "animate-spin" : "" }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 703,
                columnNumber: 13
              }, void 0),
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            ...
            className: [
              "flex items-center gap-1 px-2 py-1 rounded text-xs transition-colors",
              showPresets ? "text-accent-primary bg-dark-bgTertiary" : "text-text-secondary hover:text-text-primary hover:bg-dark-bgTertiary"
            ].join(" "),
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(BookOpen, { size: 11 }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 716,
                columnNumber: 13
              }, void 0),
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            onClick: () => {
              var _a2;
              (_a2 = importInputRef.current) == null ? void 0 : _a2.click();
            },
            ...
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Upload, { size: 11 }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 725,
                columnNumber: 13
              }, void 0),
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            ...
            className: "flex items-center gap-1 px-2 py-1 rounded text-xs text-text-secondary hover:text-text-primary hover:bg-dark-bgTertiary transition-colors",
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Download, { size: 11 }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 733,
                columnNumber: 13
              }, void 0),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "div",
          {
            ...
            style: {
              width: `${progress}%`,
              background: status.state === "error" ? "var(--color-accent-error, #e06c75)" : "var(--color-accent-primary, #7c3aed)",
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-1 min-h-0 overflow-hidden relative", children: [
      showPresets && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute inset-0 z-10 bg-dark-bgPrimary/95 backdrop-blur-sm flex flex-col overflow-hidden", style: { background: "rgba(10,10,10,0.97)" }, children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap items-center gap-1 px-3 py-2 border-b border-dark-border shrink-0", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "input",
            {
              ref: presetSearchRef,
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "button",
            {
              ...
              className: `px-2 py-0.5 rounded text-xs transition-colors ${presetCategory === "All" ? "bg-accent-primary/20 text-accent-primary" : "text-text-secondary hover:text-text-primary"}`,
              children: [
                "All (",
                SC_PRESETS.length,
                ")"
          ...
          SC_PRESET_CATEGORIES.map((cat) => {
            ...
            return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              "button",
              {
                ...
                className: `px-2 py-0.5 rounded text-xs transition-colors ${presetCategory === cat ? "bg-accent-primary/20 text-accent-primary" : "text-text-secondary hover:text-text-primary"}`,
                children: [
                  cat,
                  " (",
                  count,
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex-1 overflow-y-auto p-3", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid gap-1.5", style: { gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))" }, children: filteredPresets.map((preset, i) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-xs font-medium text-text-primary group-hover:text-accent-primary truncate", children: preset.name }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 814,
                columnNumber: 21
              }, void 0),
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-2 mt-0.5", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[10px] text-text-muted", children: preset.category }, void 0, false, {
                  fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                  lineNumber: 818,
                  columnNumber: 23
                }, void 0),
                preset.credit && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[10px] text-text-muted truncate", children: [
                  "· ",
                  preset.credit
                ] }, void 0, true, {
                  fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
              ...
              preset.tags.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap gap-1 mt-1", children: preset.tags.slice(0, 3).map((tag) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[9px] px-1 rounded bg-dark-bgSecondary text-text-muted", children: tag }, tag, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 826,
                columnNumber: 27
              }, void 0)) }, void 0, false, {
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "shrink-0 px-3 py-1.5 border-t border-dark-border text-[10px] text-text-muted flex justify-between", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { children: [
            "Community presets from ",
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "https://github.com/SCLOrkHub/SCLOrkSynths", target: "_blank", rel: "noopener noreferrer", className: "text-accent-primary hover:underline", children: "SCLOrkSynths" }, void 0, false, {
              fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
              lineNumber: 836,
              columnNumber: 44
            }, void 0),
            " (GPL-3.0). Click a preset to load its source, then Compile."
          ] }, void 0, true, {
            fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
            lineNumber: 836,
            columnNumber: 15
      ...
      scTab === "controls" && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex-1 overflow-y-auto min-h-0", children: guiResult.hasGui ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          SCGuiRenderer,
          {
            gui: guiResult,
          ...
          void 0
        ) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-center h-full text-text-muted text-xs p-4 text-center", children: config.binary ? "No GUI widgets detected in this SynthDef.\nUse the param sliders on the right." : "Compile a SynthDef first to see controls." }, void 0, false, {
          fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
          lineNumber: 862,
          columnNumber: 17
        }, void 0) }, void 0, false, {
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-52 shrink-0 border-l border-dark-border bg-dark-bgSecondary overflow-y-auto flex flex-col", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "px-3 py-2 border-b border-dark-border shrink-0 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs font-semibold text-text-muted uppercase tracking-wider", children: "Parameters" }, void 0, false, {
              fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
              lineNumber: 873,
              columnNumber: 17
            }, void 0),
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs text-text-muted", children: config.params.length > 0 ? config.params.length : "" }, void 0, false, {
              fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
              lineNumber: 876,
              columnNumber: 17
            }, void 0)
          ...
          config.params.length === 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col items-center justify-center flex-1 p-4 gap-3 text-center", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-xs text-text-muted leading-relaxed", children: "Compile to auto-extract params, or add manually." }, void 0, false, {
              fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
              lineNumber: 883,
              columnNumber: 19
            }, void 0),
            ...
            lineNumber: 882,
            columnNumber: 17
          }, void 0) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col p-3 gap-4", children: [
            config.params.map((param) => {
              ...
              return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-1.5", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between gap-1", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs text-text-secondary font-mono truncate flex-1", title: param.name, children: param.name }, void 0, false, {
                    fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                    lineNumber: 901,
                    columnNumber: 27
                  }, void 0),
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs text-text-muted font-mono shrink-0", children: Number(param.value.toPrecision(3)) }, void 0, false, {
                    fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                    lineNumber: 904,
                    columnNumber: 27
                  }, void 0),
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-1 mt-0.5", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    "input",
                    {
                      type: "number",
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-text-muted text-xs shrink-0", children: "—" }, void 0, false, {
                    fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                    lineNumber: 933,
                    columnNumber: 27
                  }, void 0),
    ...
    status.state === "error" && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "shrink-0 border-t border-dark-border bg-[#0d1117] flex flex-col", style: { maxHeight: 200 }, children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between px-3 py-1.5 border-b border-dark-border bg-dark-bgSecondary shrink-0", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs font-semibold text-accent-error uppercase tracking-wider", children: "sclang output" }, void 0, false, {
          fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
          lineNumber: 963,
          columnNumber: 13
        }, void 0),
        status.rawOutput && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            onClick: () => {
              void navigator.clipboard.writeText(status.rawOutput ?? "");
            },
            className: "flex items-center gap-1 text-xs text-text-muted hover:text-text-secondary transition-colors",
            title: "Copy to clipboard",
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Copy, { size: 10 }, void 0, false, {
                fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
                lineNumber: 972,
                columnNumber: 17
              }, void 0),
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "pre",
        {
          ...
          children: status.rawOutput ? status.rawOutput : status.message
        },
        void 0,
        false,
        {
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between px-3 py-2 bg-dark-bgSecondary border-t border-dark-border shrink-0", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex-1 min-w-0 overflow-hidden", children: renderStatus() }, void 0, false, {
        fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
        lineNumber: 991,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "button",
        {
          ...
          className: [
            ...
            status.state === "compiling" ? "bg-dark-bgTertiary text-text-muted cursor-not-allowed" : "bg-accent-primary text-dark-bg hover:opacity-90"
          ].join(" "),
          children: [
            status.state === "compiling" ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Loader, { size: 12, className: "animate-spin" }, void 0, false, {
              fileName: "/Users/spot/Code/DEViLBOX/src/components/instruments/SuperColliderEditor.tsx",
              lineNumber: 1006,
              columnNumber: 15
