...
const AVAILABLE_EFFECTS = [
  ...
  ...GUITARML_MODEL_REGISTRY.map((model) => ({
    category: "neural",
    type: "Neural",
    // Required so modals don't fall back to 'Distortion'
    neuralModelIndex: model.index,
    label: model.name,
    group: model.category === "overdrive" ? "Neural Overdrive" : model.category === "distortion" ? "Neural Distortion" : model.category === "amplifier" ? "Neural Amp" : "Neural Effect",
    description: `${model.fullName} - ${model.description}`
  })),
  // ===== BUZZMACHINE (Jeskola Buzz WASM effects) =====
  // Distortion
  { category: "buzzmachine", type: "BuzzDistortion", label: "Arguru Distortion", group: "Buzz Distortion", description: "Classic Buzz distortion effect (Arguru)" },
  { category: "buzzmachine", type: "BuzzOverdrive", label: "Geonik Overdrive", group: "Buzz Distortion", description: "Warm overdrive (Geonik)" },
  { category: "buzzmachine", type: "BuzzDistortion2", label: "Jeskola Distortion", group: "Buzz Distortion", description: "Jeskola hard distortion" },
  { category: "buzzmachine", type: "BuzzDist2", label: "Elak Dist2", group: "Buzz Distortion", description: "Elak distortion v2" },
  { category: "buzzmachine", type: "BuzzSoftSat", label: "Graue Soft Saturation", group: "Buzz Distortion", description: "Gentle saturation (Graue)" },
  { category: "buzzmachine", type: "BuzzStereoDist", label: "WhiteNoise Stereo Dist", group: "Buzz Distortion", description: "Stereo distortion (WhiteNoise)" },
  // Filter
  { category: "buzzmachine", type: "BuzzSVF", label: "Elak State Variable Filter", group: "Buzz Filter", description: "Multi-mode SVF (LP/HP/BP/Notch)" },
  { category: "buzzmachine", type: "BuzzPhilta", label: "FSM Philta", group: "Buzz Filter", description: "Resonant filter (FSM)" },
  { category: "buzzmachine", type: "BuzzNotch", label: "CyanPhase Notch", group: "Buzz Filter", description: "Phase notch filter (CyanPhase)" },
  { category: "buzzmachine", type: "BuzzZfilter", label: "Q Zfilter", group: "Buzz Filter", description: "Z-plane filter (Q)" },
  // Reverb & Delay
  { category: "buzzmachine", type: "BuzzDelay", label: "Jeskola Delay", group: "Buzz Delay", description: "Classic Buzz delay (Jeskola)" },
  { category: "buzzmachine", type: "BuzzCrossDelay", label: "Jeskola Cross Delay", group: "Buzz Delay", description: "Stereo cross-feedback delay" },
  { category: "buzzmachine", type: "BuzzFreeverb", label: "Jeskola Freeverb", group: "Buzz Reverb", description: "Freeverb reverb (Jeskola)" },
  { category: "buzzmachine", type: "BuzzPanzerDelay", label: "FSM Panzer Delay", group: "Buzz Delay", description: "Heavy multi-tap delay (FSM)" },
  // Modulation
  { category: "buzzmachine", type: "BuzzChorus", label: "FSM Chorus", group: "Buzz Modulation", description: "Chorus effect (FSM)" },
  { category: "buzzmachine", type: "BuzzChorus2", label: "FSM Chorus 2", group: "Buzz Modulation", description: "Enhanced chorus v2 (FSM)" },
  { category: "buzzmachine", type: "BuzzWhiteChorus", label: "WhiteNoise White Chorus", group: "Buzz Modulation", description: "White chorus (WhiteNoise)" },
  { category: "buzzmachine", type: "BuzzFreqShift", label: "Bigyo Frequency Shifter", group: "Buzz Modulation", description: "Frequency shifter (Bigyo)" },
  // Dynamics
  { category: "buzzmachine", type: "BuzzCompressor", label: "Geonik Compressor", group: "Buzz Dynamics", description: "Compressor (Geonik)" },
  { category: "buzzmachine", type: "BuzzLimiter", label: "Ld Soft Limiter", group: "Buzz Dynamics", description: "Soft limiter (Ld)" },
  { category: "buzzmachine", type: "BuzzExciter", label: "Oomek Exciter", group: "Buzz Dynamics", description: "Harmonic exciter (Oomek)" },
  { category: "buzzmachine", type: "BuzzMasterizer", label: "Oomek Masterizer", group: "Buzz Dynamics", description: "Mastering processor (Oomek)" },
  // EQ & Stereo
  { category: "buzzmachine", type: "BuzzStereoGain", label: "DedaCode Stereo Gain", group: "Buzz Stereo", description: "Stereo gain/balance (DedaCode)" }
];
function getEffectsByGroup() {
  const grouped = {};
  const wasmTestGroup = [];
...
export {
  AVAILABLE_EFFECTS as A,
  getEffectsByGroup as g
};
