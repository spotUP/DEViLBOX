...
class ClipperEffect extends ToneAudioNode {
  name = "Clipper";
  input;
  output;
  dryGain;
  ...
  static async ensureInitialized(ctx) {
    ...
    const p = (async () => {
      ...
      const [wasmResp, jsResp] = await Promise.all([
        fetch(`${base}clipper/Clipper.wasm`),
        fetch(`${base}clipper/Clipper.js`)
      ]);
