...
const MAGIC_MTHD = (77 << 24 | 84 << 16 | 104 << 8 | 100) >>> 0;
const MAGIC_MTRK = (77 << 24 | 84 << 16 | 114 << 8 | 107) >>> 0;
function isMIDILoricielFormat(buffer) {
...
function parseMIDILoricielFile(buffer, filename) {
...
export {
  isMIDILoricielFormat,
  parseMIDILoricielFile
};
