...
function findWasmBinary() {
    return locateFile('FurnaceWave.wasm');
}
...
function assignWasmExports(wasmExports) {
  _furnace_wave_init = Module['_furnace_wave_init'] = createExportWrapper('furnace_wave_init', 2);
  _furnace_wave_start = Module['_furnace_wave_start'] = createExportWrapper('furnace_wave_start', 0);
  _furnace_wave_shutdown = Module['_furnace_wave_shutdown'] = createExportWrapper('furnace_wave_shutdown', 0);
  _furnace_wave_load_config = Module['_furnace_wave_load_config'] = createExportWrapper('furnace_wave_load_config', 2);
  _furnace_wave_dump_config = Module['_furnace_wave_dump_config'] = createExportWrapper('furnace_wave_dump_config', 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createFurnaceWave;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createFurnaceWave;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createFurnaceWave);
