...
;
	...
	dc.b '$VER: SoundMon 2.0 player module V1.5 (03 Sep 92)',0
	even
...
Int
	...
	jsr	bpmusic 			; DudelDiDum
	movem.l	(sp)+,d0-d7/a0-a6
	rts

*-----------------------------------------------------------------------*
;
; Testet auf SoundMon-Modul
...
bp_buffer	ds.b $208			; bpsong-null
