...
;
	...
	dc.b '$VER: SoundTracker 2.6 player module V1.0 (03 Sep 92)',0
	even
...
PName		dc.b 'SoundTracker26',0
CName		dc.b 'MnemoTroN,',10
...
*-----------------------------------------------------------------------*
;
; Testet auf ST26-Modul

Chk
	move.l	dtg_ChkData(a5),a0
	move.l	$5b8(a0),d0
	subi.l	#'MTN'<<8,d0			; SoundTracker 2.6 ?
	rts
...
mt_playerdata:	blk.b	mt_datalen,0
mt_samplestarts:blk.l	31,0
mt_voice1:	blk.b	mt_voicelen,0
mt_voice2:	blk.b	mt_voicelen,0
mt_voice3:	blk.b	mt_voicelen,0
mt_voice4:	blk.b	mt_voicelen,0
