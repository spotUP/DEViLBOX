...
lbC023DBC
	bra	lbC0240C2		; Interrupt

lbC023DC0
	bra	lbC023E14		; Init Module

lbC023DC4
	bra	lbC024076		; ???

lbC023DC8
	bra	lbC023FCC		; Set Subsong

lbC023DCC
	bra	lbC02400A		; ???

lbC023DD0
	bra	lbC023F60		; Set Volume

lbC023DD4
	bra	lbC023F26		; Shutdown
...
lbC0240EC
	subq.b	#$01,d0
	move.b	d0,$0024(a5)
	move.b	$0028(a5),$0021(a5)
	move.b	#$00,$002D(a5)
	lea	lbW02489E(pc),a0
	bsr.s	lbC024144
	move.b	$0029(a5),$0021(a5)
	move.b	#$01,$002D(a5)
	lea	lbW02494E(pc),a0
	bsr.s	lbC024144
	move.b	$002A(a5),$0021(a5)
	move.b	#$02,$002D(a5)
	lea	lbW0249FE(pc),a0
	bsr.s	lbC024144
	move.b	$002B(a5),$0021(a5)
	move.b	#$03,$002D(a5)
	lea	lbW024AAE(pc),a0
	bsr.s	lbC024144
	move.b	$002C(a5),d0
