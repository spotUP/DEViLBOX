...
compa:	move.b	(a0)+,d0
	...
	move.l	a4,songdata2
	add.l	d6,songdata2	;goedesong verwijzen
	lea	128(a4),a4
...
;	move.w	#$0f0f,$dff180
	...
	move.l	#$80808080,chtab
	move.l	#chtab,checkpnt
...
effjmptab:
	dc.l	ruts,pfilter,pmix,pscrl,pscrr,pupsmple,pdwnsmple
	dc.l	pnega,pmadmix,padda,pfilt2,pmorph,pmorphf,pfilt3
	dc.l	pnega2,pcnega
	blk.l	16,ruts
