...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_is2_create','_is2_destroy','_is2_subsong_count','_is2_select_subsong','_is2_channel_count','_is2_set_channel_mask','_is2_render','_is2_render_multi','_is2_has_ended','_is2_get_instrument_count','_is2_get_num_track_lines','_is2_get_num_positions','_is2_get_cell','_is2_set_cell','_is2_get_position','_is2_set_position','_is2_get_instrument_param','_is2_set_instrument_param','_is2_export','_malloc','_free']" \
