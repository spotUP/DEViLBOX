...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_is2_create','_is2_destroy','_is2_subsong_count','_is2_select_subsong','_is2_channel_count','_is2_set_channel_mask','_is2_render','_is2_render_multi','_is2_has_ended','_malloc','_free']" \
