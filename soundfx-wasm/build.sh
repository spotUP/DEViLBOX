...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_sfx_create','_sfx_destroy','_sfx_subsong_count','_sfx_select_subsong','_sfx_channel_count','_sfx_set_channel_mask','_sfx_render','_sfx_render_multi','_sfx_has_ended','_sfx_get_instrument_count','_sfx_get_num_patterns','_sfx_get_cell','_sfx_set_cell','_sfx_get_instrument_param','_sfx_set_instrument_param','_sfx_export','_malloc','_free']" \
