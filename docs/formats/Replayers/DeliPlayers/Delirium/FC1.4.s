...
;
	...
	dc.b '$VER: Future Composer 1.4 player module V2.0 (05 Sep 92)',0
	even
...
PName	dc.b 'FutureComposer_1.4',0
...
Int
	...
	; bug in the original replayroutine !!!
	moveq	#6,d6
	; you will hear strange noises if you don't include this instruction !
...
nonewnote:
	...
	lea V1data(pc),a0
	bsr effects
	move.w fc_SndLVol,d1		; added by Delirium
	bsr fc_volbal			;
	move.l d0,$a6(a6)
	lea V2data(pc),a0
	bsr effects
	move.w fc_SndRVol,d1		; added by Delirium
	bsr fc_volbal			;
	move.l d0,$b6(a6)
	lea V3data(pc),a0
	bsr effects
