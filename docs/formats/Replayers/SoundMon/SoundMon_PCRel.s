...
Start	move.l $4.w,a6
	jsr -132(a6)
	bsr bpinit			;Init music

.sync	cmp.b #$80,$dff006			;Wait for line $80
	bne.s .sync

	move.w #$f00,$dff180
	bsr bpmusic			;Play the music
	move.w #$000,$dff180
	...
	move.b $dff006,d0
	move.b d0,most(a6)
.mraster	cmp.b $dff006,d0
	bgt.s .mraster
	move.w #$006,$dff180		;Show most rastertime!

	btst #6,$bfe001
	bne.s .sync			;Wait for the left button!
	move.w #$f,$dff096
	move.l $4.w,a6
	jsr -138(a6)
	moveq #0,d0
