...
**Status:** EDITABLE — parser decodes patterns + order list; uadePatternLayout drives edit + export (UADE synthesizes audio)
...
**Replayer reference:** `third-party/uade-3.05/players/TomyTracker`
...
- **Wanted Team asm:** `third-party/uade-3.05/amigasrc/players/wanted_team/TomyTracker/src/Tomy Tracker_v2.asm`
- **UADE player:** `third-party/uade-3.05/players/TomyTracker`
