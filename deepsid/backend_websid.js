...
var ra=[function(){console.log("info cannot be retrieved  from corrupt .mus file")},function(){console.log("ERROR: PSID INIT hangs")},function(){console.log("FATAL ERROR: This BASIC song requires emulator to be configured with optional KERNAL ROM and BASIC ROM")},function(b){console.log("JAM 0:  $"+b.toString(16))},function(){console.log("FATAL ERROR: no free memory for driver")}];I=1024;J=I+2344208;ma.push({g:function(){sa()}},{g:function(){ta()}});a.STATIC_BASE=I;a.STATIC_BUMP=2344208;J+=16;
...
window.SIDBackendAdapter = SIDBackendAdapter;
