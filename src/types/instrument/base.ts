...
export type SynthType =
  ...
  | 'SawteethSynth'   // Sawteeth software synth (osc+filter+env+arp WASM)
  | 'EupminiSynth'    // FM Towns Euphony (4-op FM + PCM WASM)
  // Phase 2 — WASM replayer formats with string-param instrument APIs
  | 'FutureComposerWasmSynth'  // Future Composer 1.3/1.4 (WASM replayer)
  | 'QuadraComposerWasmSynth'  // QuadraComposer (WASM replayer)
  | 'ArtOfNoiseSynth'          // Art of Noise AON4/AON8 (WASM replayer)
  | 'MusicAssemblerSynth'      // Music-Assembler (WASM replayer)
  | 'BenDaglishSynth'          // Ben Daglish (WASM replayer)
  | 'SoundControlWasmSynth'    // Sound Control (WASM replayer)
  | 'ActionamicsWasmSynth'     // Actionamics (WASM replayer)
  | 'ActivisionProWasmSynth'   // Activision Pro (WASM replayer)
  | 'FaceTheMusicWasmSynth'    // Face The Music (WASM replayer)
  // Phase 3/4 — Playback-only WASM replayer formats
  | 'SonixSynth'               // Sonix (hybrid PCM/synth/IFF/SMUS)
  | 'PxtoneSynth'              // PxTone (wavetable/PCM/noise)
  | 'OrganyaSynth'             // Organya (Cave Story wavetable)
  ...
  | 'DeltaMusic2WasmSynth'     // Delta Music 2.0 (WASM replayer variant)
  ...
  | 'OktalyzerWasmSynth'       // Oktalyzer (WASM replayer)
  | 'PmdminiSynth'             // PMD (PC-98 FM)
  | 'RonKlarenWasmSynth'       // Ron Klaren (WASM replayer variant)
