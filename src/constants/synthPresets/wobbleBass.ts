...
import type { WobbleBassConfig } from '../../types/instrument';
...
export const WOBBLE_BASS_PRESETS: SynthPreset[] = [
  ...
  },
  {
    ...
    config: {
      ...
      unison: { voices: 1, detune: 0, stereoSpread: 0 },
      filter: { type: 'lowpass', cutoff: 2000, resonance: 50, rolloff: -24, drive: 40, keyTracking: 20 },
  ...
  },
  {
    ...
    config: {
      ...
      envelope: { attack: 0.005, decay: 0.1, sustain: 0.9, release: 0.05 },
      distortion: { enabled: false, type: 'soft', drive: 0, tone: 50 },
      formant: { enabled: false, vowel: 'A', morph: 0, lfoAmount: 0 },
    } as Partial<WobbleBassConfig>,
  },
  {
    ...
    config: {
      ...
      unison: { voices: 1, detune: 0, stereoSpread: 0 },
      filter: { type: 'lowpass', cutoff: 3000, resonance: 40, rolloff: -24, drive: 50, keyTracking: 10 },
  ...
  },
  {
    ...
    config: {
      ...
      filter: { type: 'lowpass', cutoff: 1000, resonance: 50, rolloff: -24, drive: 25, keyTracking: 0 },
      filterEnvelope: { amount: 50, attack: 0, decay: 300, sustain: 20, release: 200 },
  ...
  },
  {
    ...
    config: {
      ...
      envelope: { attack: 0.003, decay: 0.15, sustain: 0.6, release: 0.08 },
  ...
  },
  {
    ...
    config: {
      ...
      envelope: { attack: 0.003, decay: 0.2, sustain: 0.7, release: 0.08 },
