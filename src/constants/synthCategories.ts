...
export const SYNTH_INFO: Record<SynthType, SynthInfo> = {
  ...
  MAMERolandSA: {
    ...
    name: 'Roland SA',
    shortName: 'RSA',
    description: 'Roland Structured Adaptive synthesis - silicon-accurate piano engine (needs ROM)',
    bestFor: ['Piano', 'Electric piano', 'Roland keys', '80s digital piano'],
    icon: 'Piano',
    color: 'text-sky-400',
  },
  MAMESN76477: {
