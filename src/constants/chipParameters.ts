...
export const CHIP_SYNTH_DEFS: Record<string, ChipSynthDef> = {
  ...
  MAMETMS5220: {
    ...
    name: 'Speak & Spell TMS5220',
    subtitle: 'TI TMS5220 — Speak & Spell (1978)',
    color: '#d946ef',
    presetCount: 8,
    ...
    parameters: [
      ...
      { key: 'speechText', label: 'Speech Text', group: 'Speech', type: 'text', default: 0, defaultText: 'HELLO WORLD', placeholder: 'Type text and press Speak' },
      { key: 'vowelSequence', label: 'Vowel Editor', group: 'Speech', type: 'vowelEditor', default: 0 },
      { key: 'romSpeech', label: 'ROM Speech', group: 'ROM Speech', type: 'select', min: 0, max: 141, default: 0, formatValue: 'int', options: [
        { value: 0, label: '(Text-to-Speech)' },
        // Letters A-Z (ROM words 0-25)
        { value: 1, label: 'A' }, { value: 2, label: 'B' }, { value: 3, label: 'C' },
        { value: 4, label: 'D' }, { value: 5, label: 'E' }, { value: 6, label: 'F' },
        { value: 7, label: 'G' }, { value: 8, label: 'H' }, { value: 9, label: 'I' },
        { value: 10, label: 'J' }, { value: 11, label: 'K' }, { value: 12, label: 'L' },
        { value: 13, label: 'M' }, { value: 14, label: 'N' }, { value: 15, label: 'O' },
        { value: 16, label: 'P' }, { value: 17, label: 'Q' }, { value: 18, label: 'R' },
        { value: 19, label: 'S' }, { value: 20, label: 'T' }, { value: 21, label: 'U' },
        { value: 22, label: 'V' }, { value: 23, label: 'W' }, { value: 24, label: 'X' },
        { value: 25, label: 'Y' }, { value: 26, label: 'Z' },
        // Vocabulary words (ROM words 26+)
        { value: 27, label: 'ABOUT' }, { value: 28, label: 'AFTER' }, { value: 29, label: 'AGAIN' },
        { value: 30, label: 'ANSWER' }, { value: 31, label: 'BEAUTY' }, { value: 32, label: 'BETWEEN' },
        { value: 33, label: 'BOY' }, { value: 34, label: 'BUILT' }, { value: 35, label: 'BUSY' },
        { value: 36, label: 'BUY' }, { value: 37, label: 'CEILING' }, { value: 38, label: 'CIRCLE' },
        { value: 39, label: 'CLOWN' }, { value: 40, label: 'COME' }, { value: 41, label: 'COULD' },
        { value: 42, label: 'COUNTRY' }, { value: 43, label: 'COUSIN' }, { value: 44, label: 'DOES' },
        { value: 45, label: 'DOUBLE' }, { value: 46, label: 'ENOUGH' }, { value: 47, label: 'EVER' },
        { value: 48, label: 'EYE' }, { value: 49, label: 'FRIEND' }, { value: 50, label: 'FROM' },
        { value: 51, label: 'GHOST' }, { value: 52, label: 'GIRL' }, { value: 53, label: 'GOES' },
        { value: 54, label: 'GONE' }, { value: 55, label: 'GOOD' }, { value: 56, label: 'GREAT' },
        { value: 57, label: 'GUARD' }, { value: 58, label: 'GUESS' }, { value: 59, label: 'GYM' },
        { value: 60, label: 'HALF' }, { value: 61, label: 'HAVE' }, { value: 62, label: 'HEART' },
        { value: 63, label: 'HERE' }, { value: 64, label: 'HIDDEN' }, { value: 65, label: 'HOUR' },
        { value: 66, label: 'IDEA' }, { value: 67, label: 'ISLE' }, { value: 68, label: 'JOIN' },
        { value: 69, label: 'KEY' }, { value: 70, label: 'KNOW' }, { value: 71, label: 'LAUGH' },
        { value: 72, label: 'LEARN' }, { value: 73, label: 'LISTEN' }, { value: 74, label: 'LOVE' },
        { value: 75, label: 'MACHINE' }, { value: 76, label: 'MANY' }, { value: 77, label: 'MEANT' },
        { value: 78, label: 'MOVE' }, { value: 79, label: 'NONE' }, { value: 80, label: 'OCEAN' },
        { value: 81, label: 'OF' }, { value: 82, label: 'ONE' }, { value: 83, label: 'ONLY' },
        { value: 84, label: 'OTHER' }, { value: 85, label: 'OVEN' }, { value: 86, label: 'OUTSIDE' },
        { value: 87, label: 'PEOPLE' }, { value: 88, label: 'PERIOD' }, { value: 89, label: 'PHONE' },
        { value: 90, label: 'PIECE' }, { value: 91, label: 'PRETTY' }, { value: 92, label: 'PROMISE' },
        { value: 93, label: 'PSYCHOLOGY' }, { value: 94, label: 'QUIET' }, { value: 95, label: 'READY' },
        { value: 96, label: 'RIGHT' }, { value: 97, label: 'ROUGH' }, { value: 98, label: 'SAID' },
        { value: 99, label: 'SAYS' }, { value: 100, label: 'SCHOOL' }, { value: 101, label: 'SCIENCE' },
        { value: 102, label: 'SCISSORS' }, { value: 103, label: 'SECRET' }, { value: 104, label: 'SHOULD' },
        { value: 105, label: 'SIGN' }, { value: 106, label: 'SOME' }, { value: 107, label: 'SPECIAL' },
        { value: 108, label: 'SQUARE' }, { value: 109, label: 'STRAIGHT' }, { value: 110, label: 'SUGAR' },
        { value: 111, label: 'SURE' }, { value: 112, label: 'THEIR' }, { value: 113, label: 'THERE' },
        { value: 114, label: 'THEY' }, { value: 115, label: 'THOUGH' }, { value: 116, label: 'THOUGHT' },
        { value: 117, label: 'THROUGH' }, { value: 118, label: 'TOGETHER' }, { value: 119, label: 'TROUBLE' },
        { value: 120, label: 'TWO' }, { value: 121, label: 'UPON' }, { value: 122, label: 'USUAL' },
        { value: 123, label: 'VERY' }, { value: 124, label: 'WAS' }, { value: 125, label: 'WATCH' },
        { value: 126, label: 'WATER' }, { value: 127, label: 'WEAR' }, { value: 128, label: 'WEIRD' },
        { value: 129, label: 'WHAT' }, { value: 130, label: 'WHERE' }, { value: 131, label: 'WHO' },
        { value: 132, label: 'WOMEN' }, { value: 133, label: 'WON' }, { value: 134, label: 'WORD' },
        { value: 135, label: 'WORK' }, { value: 136, label: 'WOULD' }, { value: 137, label: 'WRITE' },
        { value: 138, label: 'WRONG' }, { value: 139, label: 'YOU' }, { value: 140, label: 'YOUR' },
        { value: 141, label: 'ZERO' },
      ]},
      { key: 'volume', label: 'Volume', group: 'Output', type: 'knob', min: 0, max: 1, step: 0.01, default: 0.8, formatValue: 'percent' },
  ...
  MAMES14001A: {
    ...
    subtitle: 'SSi TSI S14001A — Berzerk (1980)',
    color: '#ef4444',
    presetCount: 8,
    presetNames: ['AH', 'EE', 'IH', 'OH', 'OO', 'NN', 'ZZ', 'HH'],
    romConfig: {
    ...
    parameters: [
      ...
      { key: 'vowelSequence', label: 'Vowel Editor', group: 'Speech', type: 'vowelEditor', default: 0 },
      { key: 'romSpeech', label: 'ROM Speech', group: 'ROM Speech', type: 'select', min: 0, max: 34, default: 0, formatValue: 'int', options: [
        // Phrases first (values 0-5)
        ...
        // Individual words (values 6+, word index = value - 6)
        { value: 6, label: 'HELP' }, { value: 7, label: 'KILL' }, { value: 8, label: 'ATTACK' },
        { value: 9, label: 'CHARGE' }, { value: 10, label: 'GOT' }, { value: 11, label: 'SHOOT' },
        { value: 12, label: 'GET' }, { value: 13, label: 'IS' }, { value: 14, label: 'ALERT' },
        { value: 15, label: 'DETECTED' }, { value: 16, label: 'THE' }, { value: 17, label: 'IN' },
        { value: 18, label: 'IT' }, { value: 19, label: 'THERE' }, { value: 20, label: 'WHERE' },
        { value: 21, label: 'HUMANOID' }, { value: 22, label: 'COINS' }, { value: 23, label: 'POCKET' },
        { value: 24, label: 'INTRUDER' }, { value: 25, label: 'NO' }, { value: 26, label: 'ESCAPE' },
        { value: 27, label: 'DESTROY' }, { value: 28, label: 'MUST' }, { value: 29, label: 'NOT' },
        { value: 30, label: 'CHICKEN' }, { value: 31, label: 'FIGHT' }, { value: 32, label: 'LIKE' },
        { value: 33, label: 'A' }, { value: 34, label: 'ROBOT' },
      ]},
      { key: 'volume', label: 'Volume', group: 'Output', type: 'knob', min: 0, max: 1, step: 0.01, default: 0.8, formatValue: 'percent' },
  ...
  MAMEVLM5030: {
    ...
    subtitle: 'Sanyo VLM5030 — Track & Field (1983)',
    color: '#3b82f6',
    presetCount: 8,
  ...
  MAMEHC55516: {
    ...
    subtitle: 'Harris HC55516 CVSD — Sinistar (1982)',
    color: '#a855f7',
    presetCount: 8,
    presetNames: ['AH', 'EE', 'IH', 'OH', 'OO', 'NN', 'ZZ', 'HH'],
    romConfig: {
    ...
    parameters: [
      ...
      { key: 'vowelSequence', label: 'Vowel Editor', group: 'Speech', type: 'vowelEditor', default: 0 },
      { key: 'romSpeech', label: 'ROM Speech', group: 'ROM Speech', type: 'select', min: 0, max: 15, default: 0, formatValue: 'int', options: [
        // Phrases first (values 0-6)
        ...
        // Individual words (values 7+, word index = value - 7)
        { value: 7, label: 'ROAR' }, { value: 8, label: 'I' }, { value: 9, label: 'AM' },
        { value: 10, label: 'SINISTAR' }, { value: 11, label: 'COWARD' }, { value: 12, label: 'RUN' },
        { value: 13, label: 'LIVE' }, { value: 14, label: 'HUNGER' }, { value: 15, label: 'BEWARE' },
      ]},
      { key: 'volume', label: 'Volume', group: 'Output', type: 'knob', min: 0, max: 1, step: 0.01, default: 0.8, formatValue: 'percent' },
      { key: 'preset', label: 'Vowel', group: 'Formants', type: 'select', min: 0, max: 7, default: 0, formatValue: 'int', options: [
        { value: 0, label: 'AH' }, { value: 1, label: 'EE' }, { value: 2, label: 'IH' },
