...
export const CHIP_SYNTH_DEFS: Record<string, ChipSynthDef> = {
  ...
  MAMES14001A: {
    ...
    parameters: [
      ...
      { key: 'vowelSequence', label: 'Vowel Editor', group: 'Speech', type: 'vowelEditor', default: 0 },
      { key: 'romWord', label: 'ROM Word', group: 'ROM Speech', type: 'select', min: 0, max: 28, default: 0, formatValue: 'int', options: [
        { value: 0, label: 'HELP' }, { value: 1, label: 'KILL' }, { value: 2, label: 'ATTACK' },
        { value: 3, label: 'CHARGE' }, { value: 4, label: 'GOT' }, { value: 5, label: 'SHOOT' },
        { value: 6, label: 'GET' }, { value: 7, label: 'IS' }, { value: 8, label: 'ALERT' },
        { value: 9, label: 'DETECTED' }, { value: 10, label: 'THE' }, { value: 11, label: 'IN' },
        { value: 12, label: 'IT' }, { value: 13, label: 'THERE' }, { value: 14, label: 'WHERE' },
        { value: 15, label: 'HUMANOID' }, { value: 16, label: 'COINS' }, { value: 17, label: 'POCKET' },
        { value: 18, label: 'INTRUDER' }, { value: 19, label: 'NO' }, { value: 20, label: 'ESCAPE' },
        { value: 21, label: 'DESTROY' }, { value: 22, label: 'MUST' }, { value: 23, label: 'NOT' },
  ...
  MAMEVLM5030: {
    ...
    parameters: [
      ...
      { key: 'vowelSequence', label: 'Vowel Editor', group: 'Speech', type: 'vowelEditor', default: 0 },
      { key: 'romWord', label: 'ROM Word', group: 'ROM Speech', type: 'select', min: 0, max: 59, default: 0, formatValue: 'int', options: [
        { value: 0, label: 'READY' }, { value: 1, label: 'SET' }, { value: 2, label: 'GO' },
        { value: 3, label: '100 METER' }, { value: 4, label: 'DASH' }, { value: 5, label: 'LONG JUMP' },
        { value: 6, label: 'JAVELIN' }, { value: 7, label: 'HURDLES' }, { value: 8, label: 'HAMMER' },
        { value: 9, label: 'HIGH JUMP' }, { value: 10, label: 'TIME' }, { value: 11, label: 'SCORE' },
        { value: 12, label: 'POINTS' }, { value: 13, label: 'METERS' }, { value: 14, label: 'NEXT' },
        { value: 15, label: 'BONUS' }, { value: 16, label: 'FOUL' }, { value: 17, label: 'RECORD' },
        { value: 18, label: 'NEW RECORD' }, { value: 19, label: 'GAME OVER' },
        { value: 20, label: 'ZERO' }, { value: 21, label: 'ONE' }, { value: 22, label: 'TWO' },
        { value: 23, label: 'THREE' }, { value: 24, label: 'FOUR' }, { value: 25, label: 'FIVE' },
        { value: 26, label: 'SIX' }, { value: 27, label: 'SEVEN' }, { value: 28, label: 'EIGHT' },
        { value: 29, label: 'NINE' },
        { value: 30, label: 'WORD 30' }, { value: 31, label: 'WORD 31' }, { value: 32, label: 'WORD 32' },
        { value: 33, label: 'WORD 33' }, { value: 34, label: 'WORD 34' }, { value: 35, label: 'WORD 35' },
        { value: 36, label: 'WORD 36' }, { value: 37, label: 'WORD 37' }, { value: 38, label: 'WORD 38' },
        { value: 39, label: 'WORD 39' }, { value: 40, label: 'WORD 40' }, { value: 41, label: 'WORD 41' },
        { value: 42, label: 'WORD 42' }, { value: 43, label: 'WORD 43' }, { value: 44, label: 'WORD 44' },
        { value: 45, label: 'WORD 45' }, { value: 46, label: 'WORD 46' }, { value: 47, label: 'WORD 47' },
        { value: 48, label: 'WORD 48' }, { value: 49, label: 'WORD 49' }, { value: 50, label: 'WORD 50' },
        { value: 51, label: 'WORD 51' }, { value: 52, label: 'WORD 52' }, { value: 53, label: 'WORD 53' },
  ...
  MAMEHC55516: {
    ...
    parameters: [
      ...
      { key: 'vowelSequence', label: 'Vowel Editor', group: 'Speech', type: 'vowelEditor', default: 0 },
      { key: 'romWord', label: 'ROM Speech', group: 'ROM Speech', type: 'select', min: 0, max: 8, default: 0, formatValue: 'int', options: [
