...
export const FX_PRESETS: FxPreset[] = [
  // ═══ CLEAN ═══
  { name: 'Clean Master', description: 'Gentle glue compression + tonal balance — transparent finishing', tags: ['Clean'], gainCompensationDb: 2.3,
    effects: [
  ...
  { name: 'Balanced', description: 'EQ sculpting + light compression + widening', tags: ['Clean', 'Wide'], gainCompensationDb: 6.5,
    effects: [
  ...
  { name: 'Brick Wall', description: 'Hard limiting for maximum loudness', tags: ['Loud'], gainCompensationDb: 2.7,
    effects: [
  ...
  { name: 'Swedish Chainsaw', description: 'HM-2 + JCM800 — the legendary Swedish death metal tone', tags: ['Loud', 'Grit', 'Guitar'], gainCompensationDb: -2.2,
    effects: [
  ...
  // ═══ WIDE ═══
  { name: 'Stereo Wide', description: 'Subtle stereo widening + glue compression', tags: ['Wide'], gainCompensationDb: 9.5,
    effects: [
  ...
  // ═══ VINYL / LO-FI ═══
  { name: 'Vinyl Press', description: 'ToneArm vinyl simulation — RIAA EQ, rolloff, crackle', tags: ['Vinyl', 'Lo-Fi'], gainCompensationDb: 1.9,
    effects: [
  ...
  { name: 'Turntable', description: 'ToneArm vinyl playback — wow, flutter, cartridge', tags: ['Lo-Fi', 'Vinyl'], gainCompensationDb: -0.9,
    effects: [
  ...
  { name: 'House', description: 'Warm low-end + smooth tops + glue comp', tags: ['Genre', 'DJ'], gainCompensationDb: 5.3,
    effects: [
      { category: 'tonejs', type: 'EQ3', enabled: true, wet: 100, parameters: { low: 2, mid: 0.5, high: 1 } },
  ...
  { name: 'Drum & Bass', description: 'Tight transients + sub weight + air', tags: ['Genre', 'DJ'], gainCompensationDb: 2.7,
    effects: [
  ...
  { name: 'Echo Out', description: 'BPM-synced tape echo for transitions', tags: ['DJ', 'Delay'], gainCompensationDb: -2.6,
    effects: [
  ...
  { name: 'Vox Amp Crunch', description: 'Vox amplifier — British crunch for mix character', tags: ['DJ', 'Grit'], gainCompensationDb: -4.6,
    effects: [
  ...
  { name: 'Spring Tank', description: 'Classic dub spring reverb — metallic drip', tags: ['Space', 'Dub', 'Reverb'], gainCompensationDb: 0.9,
    effects: [
  ...
  { name: 'King Tubby Filter', description: 'Resonant dub filter + echo — dramatic sweeps', tags: ['Dub', 'Creative'], gainCompensationDb: -4.1,
    effects: [
  ...
  { name: 'Tape Echo Wash', description: 'RE Tape Echo with wow/flutter — degraded repeats', tags: ['Dub', 'Delay', 'Lo-Fi'], gainCompensationDb: -5,
    effects: [
  ...
  { name: 'Dub Chamber', description: 'Spring reverb + tape echo — classic dub send', tags: ['Dub', 'Reverb', 'Delay'], gainCompensationDb: 2.4,
    effects: [
  ...
  { name: 'Clean Vocal', description: 'Compression + EQ for clean vocal chain', tags: ['Vocals', 'Clean'], gainCompensationDb: 2.4,
    effects: [
  ...
  { name: 'Frozen', description: 'Plate + pitch shift + delay — glacial, crystalline', tags: ['Ambient', 'Texture'], gainCompensationDb: 9.3,
    effects: [
  ...
  // ═══ TEXTURE ═══
  { name: 'Radiowave', description: 'Bandpass + bit-crush + tremolo — AM radio', tags: ['Texture', 'Lo-Fi'], gainCompensationDb: 12.6,
    effects: [
  ...
  { name: 'Haunted', description: 'Pitch shift down + spring + distortion — horror', tags: ['Texture', 'Creative'], gainCompensationDb: 6.3,
    effects: [
  ...
  // ═══ COMPRESSION ═══
  { name: 'Parallel Crush', description: 'Heavy parallel compression — drums, full mix', tags: ['Compression', 'Drums'], gainCompensationDb: -0.5,
    effects: [
      { category: 'tonejs', type: 'Compressor', enabled: true, wet: 100, parameters: { threshold: -30, ratio: 20, attack: 0.003, release: 0.1 } },
    ] },
  { name: 'Glue Bus', description: 'Gentle bus compression — cohesion', tags: ['Compression', 'Clean'], gainCompensationDb: 1.7,
    effects: [
      { category: 'tonejs', type: 'Compressor', enabled: true, wet: 100, parameters: { threshold: -18, ratio: 4, attack: 0.01, release: 0.25 } },
    ] },

  // ═══ DELAY ═══
  { name: 'Ambient Echo', description: 'Filtered darkening delay — ambient, *wave', tags: ['Delay', 'Ambient'], gainCompensationDb: -0.9,
    effects: [
  ...
  { name: 'Tape Echo', description: 'Warm tape delay with wow/flutter — dub, lo-fi', tags: ['Delay', 'Dub', 'Lo-Fi'], gainCompensationDb: -4.8,
    effects: [
