...
const handlers: Record<string, Handler> = {
  ...
  get_auto_dub_state: getAutoDubState,
  get_auto_dub_fire_log: getAutoDubFireLog,
  clear_auto_dub_fire_log: clearAutoDubFireLog,
  get_channel_roles: getChannelRoles,
  ...
  set_auto_dub_config: setAutoDubConfig,
  route_parameter: routeParameter,
  fire_dub_move: fireDubMove,
  release_dub_move: releaseDubMove,
