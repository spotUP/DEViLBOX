...
import { useUIStore, useAudioStore, useTrackerStore, useTransportStore, useCursorStore, useEditorStore } from '@stores';
...
const TrackerStatusContent: React.FC<{ barHeight: number }> = ({ barHeight }) => {
  ...
  const { patternLength, songDBInfo, sidMetadata } = useTrackerStore(
    useShallow((s) => ({
