...
function soundcontrolTransform(code: string): string {
  return code
...
export class SoundControlEngine extends WASMSingletonBase {
  ...
  private constructor() {
    super();
    this.initialize(SoundControlEngine.cache);
  }
  ...
  protected getLoaderConfig(): WASMLoaderConfig {
    return {
      dir: 'soundcontrol',
      workletFile: 'SoundControl.worklet.js',
      wasmFile: 'SoundControl.wasm',
      jsFile: 'SoundControl.js',
      transformJS: soundcontrolTransform,
  ...
  protected createNode(): void {
    ...
    this.workletNode.port.postMessage({
      ...
      wasmBinary: SoundControlEngine.cache.wasmBinary, jsCode: SoundControlEngine.cache.jsCode,
    });
