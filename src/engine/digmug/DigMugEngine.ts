...
function digmugTransform(code: string): string {
  return code
...
export class DigMugEngine extends WASMSingletonBase {
  private static instance: DigMugEngine | null = null;
  ...
  private constructor() {
    super();
    this.initialize(DigMugEngine.cache);
  }
  ...
  static hasInstance(): boolean {
    return !!DigMugEngine.instance && !DigMugEngine.instance._disposed;
  }

  protected getLoaderConfig(): WASMLoaderConfig {
    return {
      dir: 'digmug',
      workletFile: 'DigMug.worklet.js',
      wasmFile: 'DigMug.wasm',
      jsFile: 'DigMug.js',
      transformJS: digmugTransform,
  ...
  protected createNode(): void {
    ...
    this.workletNode.port.postMessage({
      ...
      wasmBinary: DigMugEngine.cache.wasmBinary, jsCode: DigMugEngine.cache.jsCode,
    });
