...
function synthesisTransform(code: string): string {
  return code
...
export class SynthesisEngine extends WASMSingletonBase {
  ...
  private constructor() {
    super();
    this.initialize(SynthesisEngine.cache);
  }
  ...
  protected getLoaderConfig(): WASMLoaderConfig {
    return {
      dir: 'synthesis',
      workletFile: 'Synthesis.worklet.js',
      wasmFile: 'Synthesis.wasm',
      jsFile: 'Synthesis.js',
      transformJS: synthesisTransform,
  ...
  protected createNode(): void {
    ...
    this.workletNode.port.postMessage({
      ...
      wasmBinary: SynthesisEngine.cache.wasmBinary, jsCode: SynthesisEngine.cache.jsCode,
    });
