...
export class DssEngine extends WASMSingletonBase {
  ...
  private constructor() {
    super();
    this.initialize(DssEngine.cache);
  }
  ...
  protected getLoaderConfig(): WASMLoaderConfig {
    return {
      dir: 'dss',
      workletFile: 'Dss.worklet.js',
      wasmFile: 'Dss.wasm',
      jsFile: 'Dss.js',
      transformJS: dssTransform,
  ...
  protected createNode(): void {
    ...
    this.workletNode.port.postMessage({
      ...
      wasmBinary: DssEngine.cache.wasmBinary, jsCode: DssEngine.cache.jsCode,
    });
