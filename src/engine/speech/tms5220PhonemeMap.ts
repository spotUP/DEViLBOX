...
export function samToTMS5220(samCode: string): TMS5220Frame | null {
  ...
  const map: Record<string, TMS5220Frame> = {
    ...
    'IY': { k: [12, 28, 11,  6, 10,  7,  9,  3,  5,  3], energy: 12, pitch: 8, unvoiced: false, durationMs: 150 },
    'IH': { k: [15, 25, 10,  7,  9,  7,  8,  3,  4,  3], energy: 12, pitch: 7, unvoiced: false, durationMs: 120 },
    'EH': { k: [20, 22, 10,  7,  8,  7,  8,  4,  4,  3], energy: 12, pitch: 7, unvoiced: false, durationMs: 140 },
    'AE': { k: [24, 19, 10,  8,  8,  7,  8,  4,  4,  4], energy: 12, pitch: 7, unvoiced: false, durationMs: 150 },
    'AA': { k: [23, 12,  8,  8,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 5, unvoiced: false, durationMs: 160 },
    'AH': { k: [21, 11,  8,  8,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 5, unvoiced: false, durationMs: 130 },
    'AO': { k: [19,  8,  7,  9,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 3, unvoiced: false, durationMs: 150 },
    'UH': { k: [17, 13,  7,  9,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 3, unvoiced: false, durationMs: 120 },
    'AX': { k: [18, 14,  8,  8,  8,  8,  8,  4,  4,  4], energy: 10, pitch: 5, unvoiced: false, durationMs: 90 },
    'IX': { k: [14, 23,  9,  7,  9,  7,  8,  3,  4,  3], energy: 10, pitch: 7, unvoiced: false, durationMs: 90 },
    'ER': { k: [18, 16,  9,  9,  6, 10,  7,  5,  4,  4], energy: 12, pitch: 5, unvoiced: false, durationMs: 160 },
    'UX': { k: [14,  6,  6, 10,  7,  8,  8,  5,  4,  4], energy: 12, pitch: 1, unvoiced: false, durationMs: 130 },
    'OH': { k: [19,  8,  7,  9,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 3, unvoiced: false, durationMs: 150 },

    // === Diphthongs ===
    'EY': { k: [20, 22, 10,  7,  8,  7,  8,  4,  4,  3], energy: 12, pitch: 7, unvoiced: false, durationMs: 200 },
    'AY': { k: [23, 12,  8,  8,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 5, unvoiced: false, durationMs: 200 },
    'OY': { k: [19,  8,  7,  9,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 3, unvoiced: false, durationMs: 200 },
    'AW': { k: [23, 12,  8,  8,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 5, unvoiced: false, durationMs: 200 },
    'OW': { k: [19,  8,  7,  9,  7,  8,  8,  4,  4,  4], energy: 12, pitch: 3, unvoiced: false, durationMs: 200 },
    'UW': { k: [14,  6,  6, 10,  7,  8,  8,  5,  4,  4], energy: 12, pitch: 1, unvoiced: false, durationMs: 160 },

    // === Glides / Liquids (voiced, transitional) ===
    'R*': { k: [17, 15,  9,  9,  6, 10,  7,  5,  4,  4], energy: 10, pitch: 5, unvoiced: false, durationMs: 100 },
    'RX': { k: [17, 15,  9,  9,  6, 10,  7,  5,  4,  4], energy: 10, pitch: 5, unvoiced: false, durationMs: 100 },
    'L*': { k: [16, 20,  7, 10,  5, 10,  6,  5,  3,  4], energy: 10, pitch: 5, unvoiced: false, durationMs: 110 },
    'LX': { k: [16, 20,  7, 10,  5, 10,  6,  5,  3,  4], energy: 10, pitch: 5, unvoiced: false, durationMs: 110 },
    'W*': { k: [14,  5,  5, 11,  7,  8,  9,  5,  5,  4], energy:  9, pitch: 3, unvoiced: false, durationMs: 80 },
    'WX': { k: [14,  5,  5, 11,  7,  8,  9,  5,  5,  4], energy:  9, pitch: 3, unvoiced: false, durationMs: 80 },
    'WH': { k: [14,  5,  5, 11,  7,  8,  9,  5,  5,  4], energy:  6, pitch:  0, unvoiced: true,  durationMs: 80 },
    'Y*': { k: [12, 28, 11,  6, 10,  7,  9,  3,  5,  3], energy:  9, pitch: 7, unvoiced: false, durationMs: 80 },
    'YX': { k: [12, 28, 11,  6, 10,  7,  9,  3,  5,  3], energy:  9, pitch: 7, unvoiced: false, durationMs: 80 },

    // === Nasals (voiced, nasal resonance via K3/K4 boost) ===
    'M*': { k: [20, 10,  4, 14,  5, 10,  6,  5,  3,  5], energy:  9, pitch: 5, unvoiced: false, durationMs: 120 },
    'N*': { k: [18, 19,  4, 14,  5, 10,  6,  5,  3,  5], energy:  9, pitch: 5, unvoiced: false, durationMs: 100 },
    'NX': { k: [16, 12,  4, 14,  5, 10,  6,  5,  3,  5], energy:  9, pitch: 5, unvoiced: false, durationMs: 120 },
    ...
    'Z*': { k: [10, 28, 14, 12, 11,  5, 10,  2,  6,  2], energy:  9, pitch: 5, unvoiced: false, durationMs: 130 },
    'ZH': { k: [12, 22, 13, 13, 10,  6,  9,  3,  5,  3], energy:  9, pitch: 5, unvoiced: false, durationMs: 120 },
    'V*': { k: [ 8, 20, 12,  9, 10,  5,  8,  2,  5,  2], energy:  8, pitch: 5, unvoiced: false, durationMs: 100 },
    'DH': { k: [ 8, 24, 12,  8, 10,  5,  8,  2,  6,  2], energy:  8, pitch: 5, unvoiced: false, durationMs: 80 },

    // === Affricates ===
    'CH': { k: [12, 24, 13, 12, 10,  6,  9,  3,  5,  3], energy:  8, pitch:  0, unvoiced: true,  durationMs: 120 },
    'J*': { k: [12, 24, 13, 12, 10,  6,  9,  3,  5,  3], energy:  9, pitch: 5, unvoiced: false, durationMs: 120 },

    // === Stops (burst + brief silence) ===
    'B*': { k: [22, 10,  6, 10,  5,  9,  7,  4,  3,  4], energy:  7, pitch: 5, unvoiced: false, durationMs: 60 },
    'D*': { k: [18, 22,  6, 10,  6,  8,  7,  3,  4,  3], energy:  7, pitch: 5, unvoiced: false, durationMs: 60 },
    'G*': { k: [16, 14,  6, 10,  7,  8,  8,  4,  4,  4], energy:  7, pitch: 5, unvoiced: false, durationMs: 60 },
    'GX': { k: [16, 14,  6, 10,  7,  8,  8,  4,  4,  4], energy:  7, pitch: 5, unvoiced: false, durationMs: 60 },
    ...
    // === Other ===
    'DX': { k: [18, 22,  6, 10,  6,  8,  7,  3,  4,  3], energy:  6, pitch: 5, unvoiced: false, durationMs: 40 },
