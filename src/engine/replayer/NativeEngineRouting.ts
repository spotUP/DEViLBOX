...
const WASM_ENGINES: NativeEngineDescriptor[] = [
  ...
  {
    key: 'RobHubbard',
    synthType: 'RobHubbardWasmSynth',
    suppressNotes: true,
    fileDataKey: 'robHubbardFileData',
    formats: null,
    loadMethod: 'loadTune',
    supportsPause: false,
    supportsResume: false,
    needsDirectRouting: true,
    staticRef: null,
    dynamicResolver: async () => (await import('@/engine/robhubbard/RobHubbardEngine')).RobHubbardEngine as unknown as WASMSingletonStatic,
  },
  {
    key: 'DigitalMugician',
  ...
  {
    key: 'CoreDesign',
    synthType: 'CoreDesignWasmSynth',
    suppressNotes: true,
    fileDataKey: 'coreDesignFileData',
    formats: null,
    loadMethod: 'loadTune',
    supportsPause: false,
    supportsResume: false,
    needsDirectRouting: true,
    staticRef: null,
    dynamicResolver: async () => (await import('@/engine/coredesign/CoreDesignEngine')).CoreDesignEngine as unknown as WASMSingletonStatic,
  },
  {
    key: 'DavidWhittaker',
  ...
  {
    key: 'StartrekkerAM',
    synthType: 'StartrekkerAMWasmSynth',
    suppressNotes: true,
    fileDataKey: 'startrekkerAMFileData',
    formats: null,
    loadMethod: 'loadTune',
    supportsPause: false,
    supportsResume: false,
    needsDirectRouting: true,
    staticRef: null,
    dynamicResolver: async () => (await import('@/engine/startrekker-am/StartrekkerAMEngine')).StartrekkerAMEngine as unknown as WASMSingletonStatic,
  },
  {
    key: 'UADEEditable',
