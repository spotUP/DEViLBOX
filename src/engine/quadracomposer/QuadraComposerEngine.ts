...
function quadracomposerTransform(code: string): string {
  return code
...
export class QuadraComposerEngine extends WASMSingletonBase {
  ...
  private constructor() {
    super();
    this.initialize(QuadraComposerEngine.cache);
  }
  ...
  protected getLoaderConfig(): WASMLoaderConfig {
    return {
      dir: 'quadracomposer',
      workletFile: 'QuadraComposer.worklet.js',
      wasmFile: 'QuadraComposer.wasm',
      jsFile: 'QuadraComposer.js',
      transformJS: quadracomposerTransform,
  ...
  protected createNode(): void {
    ...
    this.workletNode.port.postMessage({
      ...
      wasmBinary: QuadraComposerEngine.cache.wasmBinary, jsCode: QuadraComposerEngine.cache.jsCode,
    });
