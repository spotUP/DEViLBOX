...
// Config converters live in the lib layer (SunTronicV13.ts) to avoid a
// lib→engine import cycle; re-exported here for engine-side consumers.
export { sunSynthToConfig, sunConfigToInstrument } from '@/lib/import/formats/SunTronicV13';
