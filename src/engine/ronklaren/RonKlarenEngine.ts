...
function ronklarenTransform(code: string): string {
  return code
...
export class RonKlarenEngine extends WASMSingletonBase {
  ...
  private constructor() {
    super();
    this.initialize(RonKlarenEngine.cache);
  }
  ...
  protected getLoaderConfig(): WASMLoaderConfig {
    return {
      dir: 'ronklaren',
      workletFile: 'RonKlaren.worklet.js',
      wasmFile: 'RonKlaren.wasm',
      jsFile: 'RonKlaren.js',
      transformJS: ronklarenTransform,
