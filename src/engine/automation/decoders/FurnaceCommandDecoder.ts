export interface DecodedFurnaceCommand {
  paramId: string;
  value: number; // 0-1 normalized
}

// DivDispatchCmds subset — the most useful commands for automation
...
/**
 * Decodes a Furnace dispatch command into automation parameters.
 */
export function decodeFurnaceCommand(
  cmd: number,
  channel: number,
  value1: number,
  value2: number,
): DecodedFurnaceCommand[] {
