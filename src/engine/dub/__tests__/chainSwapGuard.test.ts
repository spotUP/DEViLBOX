 ...
 *
 * Fix: ramp `return_.gain` to 0 before the splice, defer the splice via
 * `setTimeout`, then ramp back. Source-contract test locks the invariant —
 * happy-dom can't simulate Web Audio graph state.
 */
