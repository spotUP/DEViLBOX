  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 6 }}>
        <span style={{ color: '#e94560', fontWeight: 'bold', marginRight: 8 }}>INSTRUMENT</span>
        <select
      ...
      {/* ADSR */}
      <div style={{ color: '#e94560', fontWeight: 'bold', fontSize: 10, marginTop: 4, marginBottom: 2 }}>ENVELOPE</div>
      ...
      {/* Table pointers */}
      <div style={{ color: '#e94560', fontWeight: 'bold', fontSize: 10, marginTop: 4, marginBottom: 2 }}>TABLE POINTERS</div>
      ...
      {/* Other params */}
      <div style={{ color: '#e94560', fontWeight: 'bold', fontSize: 10, marginTop: 4, marginBottom: 2 }}>SETTINGS</div>
