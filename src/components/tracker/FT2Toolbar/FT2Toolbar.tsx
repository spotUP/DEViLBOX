  ...
  return (
    <div className="ft2-toolbar">
      <div className="flex flex-1 min-w-0 flex-wrap gap-y-1 items-start">
        ...
        <VisualizerFrame variant="compact" className="min-w-0 max-w-[350px] flex-1 self-stretch border-l border-dark-border cursor-pointer group ml-auto hidden lg:flex" style={{ alignItems: 'stretch', justifyContent: 'center' }}>
