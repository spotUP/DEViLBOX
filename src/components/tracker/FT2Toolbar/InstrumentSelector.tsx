...
export const InstrumentSelector: React.FC<InstrumentSelectorProps> = ({
  ...
  return (
    <div className="ft2-numeric-group relative" ref={dropdownRef}>
      ...
      {/* Dropdown list */}
      {showDropdown && (
        <div className="absolute top-full left-0 mt-1 w-56 max-h-64 overflow-y-auto bg-dark-bgTertiary border border-dark-border rounded shadow-xl z-[99990] scrollbar-modern">
