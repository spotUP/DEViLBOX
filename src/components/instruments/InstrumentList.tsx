...
export const InstrumentList: React.FC<InstrumentListProps> = ({
  ...
  return (
    <div className={`flex flex-col h-full ${isFT2 ? 'bg-ft2-bg' : ''}`}>
      {/* Header */}
      <div className={
        isFT2
          ? 'px-3 py-2 bg-ft2-header border-b-2 border-ft2-border'
          : 'flex items-center justify-between px-3 py-2 border-b border-dark-border bg-dark-bgSecondary'
      }>
        {isFT2 ? (
