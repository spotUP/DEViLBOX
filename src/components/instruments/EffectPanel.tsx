...
const EFFECT_PARAMETERS: Record<string, EffectParameter[]> = {
  ...
  TapeSaturation: [
    { name: 'Drive', key: 'drive', min: 0, max: 100, step: 1, unit: '%', defaultValue: 50 },
    { name: 'Tone', key: 'tone', min: 2000, max: 20000, step: 100, unit: 'Hz', defaultValue: 12000 },
  ],
  SidechainCompressor: [
    { name: 'Threshold', key: 'threshold', min: -60, max: 0, step: 1, unit: 'dB', defaultValue: -24 },
    { name: 'Ratio', key: 'ratio', min: 1, max: 20, step: 0.1, unit: ':1', defaultValue: 4 },
    { name: 'Attack', key: 'attack', min: 0.001, max: 0.5, step: 0.001, unit: 's', defaultValue: 0.003 },
    { name: 'Release', key: 'release', min: 0.01, max: 1, step: 0.01, unit: 's', defaultValue: 0.25 },
    { name: 'Knee', key: 'knee', min: 0, max: 40, step: 1, unit: 'dB', defaultValue: 6 },
    { name: 'SC Gain', key: 'sidechainGain', min: 0, max: 100, step: 1, unit: '%', defaultValue: 100 },
  ],
  MoogFilter: [
    { name: 'Cutoff', key: 'cutoff', min: 20, max: 20000, step: 1, unit: 'Hz', defaultValue: 1000 },
    { name: 'Resonance', key: 'resonance', min: 0, max: 100, step: 1, unit: '%', defaultValue: 10 },
    { name: 'Drive', key: 'drive', min: 0.1, max: 4, step: 0.01, unit: 'x', defaultValue: 1 },
    { name: 'Model', key: 'model', min: 0, max: 5, step: 1, unit: '0-5', defaultValue: 0 },
    { name: 'Filter Mode', key: 'filterMode', min: 0, max: 6, step: 1, unit: '0-6', defaultValue: 1 },
  ],
  MVerb: [
    { name: 'Damping', key: 'damping', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Density', key: 'density', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Bandwidth', key: 'bandwidth', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Decay', key: 'decay', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.7 },
    { name: 'Predelay', key: 'predelay', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.0 },
    { name: 'Size', key: 'size', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.8 },
    { name: 'Gain', key: 'gain', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 1.0 },
    { name: 'Mix', key: 'mix', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.4 },
    { name: 'Early Mix', key: 'earlyMix', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
  ],
  Leslie: [
    { name: 'Speed', key: 'speed', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.0 },
    { name: 'Horn Rate', key: 'hornRate', min: 0.1, max: 10, step: 0.1, unit: 'Hz', defaultValue: 6.8 },
    { name: 'Drum Rate', key: 'drumRate', min: 0.1, max: 8, step: 0.1, unit: 'Hz', defaultValue: 5.9 },
    { name: 'Horn Depth', key: 'hornDepth', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.7 },
    { name: 'Drum Depth', key: 'drumDepth', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Doppler', key: 'doppler', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Width', key: 'width', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.8 },
    { name: 'Acceleration', key: 'acceleration', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
  ],
  SpringReverb: [
    { name: 'Decay', key: 'decay', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.6 },
    { name: 'Damping', key: 'damping', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.4 },
    { name: 'Tension', key: 'tension', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Mix', key: 'mix', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.35 },
    { name: 'Drip', key: 'drip', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.5 },
    { name: 'Diffusion', key: 'diffusion', min: 0, max: 1, step: 0.01, unit: '', defaultValue: 0.7 },
  ],
  RETapeEcho: [
