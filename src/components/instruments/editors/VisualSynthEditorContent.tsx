...
export function renderAllSections(
  ...
  smallSections.push(
    <div key="pitchenv">
      ...
      <div className={`flex flex-wrap gap-3 items-end ${!instrument.pitchEnvelope?.enabled ? 'opacity-40 pointer-events-none' : ''}`}>
  ...
  return (
    <div className="synth-tab-section p-4 space-y-4">
      ...
      <section className="bg-[#1a1a1a] rounded-xl p-4 border border-dark-border">
        ...
        <div className={`flex flex-wrap gap-3 items-end ${!instrument.pitchEnvelope?.enabled ? 'opacity-50 pointer-events-none' : ''}`}>
          <Knob
