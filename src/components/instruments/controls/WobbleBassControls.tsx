...
const KnobWrap: React.FC<{ label: string; value: number; min: number; max: number; onChange: (v: number) => void;
  ...
  <Knob value={value} min={min} max={max} onChange={onChange} label={label} size={size ?? 'sm'}
  ...
  return (
    <div className="flex flex-col gap-2 p-3 rounded-xl select-none" style={{ background: PANEL_BG, fontFamily: 'system-ui' }}>
      ...
      <div className="flex flex-wrap gap-2">
        <Section label="OSC 1" className="flex-1 min-w-[200px]">
        ...
        <Section label="OSC 2" className="flex-1 min-w-[200px]">
        ...
        <Section label="SUB" className="min-w-[120px]">
        ...
        <Section label="FM" className="min-w-[160px]">
        ...
        <Section label="UNISON" className="min-w-[160px]">
      ...
      {/* ── ROW 2: FILTER ─────────────────────────── */}
      <div className="flex flex-wrap gap-2">
        <Section label="FILTER" className="flex-1 min-w-[280px]">
          <BtnGroup items={FILTER_TYPES} labels={FILTER_LABELS} value={config.filter.type} onSelect={v => set(['filter', 'type'], v)} />
          <KnobWrap label="Cutoff" value={config.filter.cutoff} min={20} max={20000} onChange={v => set(['filter', 'cutoff'], v)} fmt={hz} size="md" />
      ...
      {/* ── ROW 3: MODULATION ─────────────────────── */}
      <div className="flex flex-wrap gap-2">
        <Section label="WOBBLE LFO" className="flex-1 min-w-[340px]">
      ...
      {/* ── ROW 4: EFFECTS ────────────────────────── */}
      <div className="flex flex-wrap gap-2">
        <Section label="DISTORTION" className="flex-1 min-w-[200px]">
        ...
        <Section label="FORMANT" className="flex-1 min-w-[200px]">
