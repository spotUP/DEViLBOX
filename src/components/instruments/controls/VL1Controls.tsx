...
export const VL1Controls: React.FC<VL1ControlsProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="p-4 space-y-4 text-xs">
      {/* Sound Selection */}
      <div>
        <h3 className="text-text-muted font-semibold mb-2 border-b border-dark-border pb-1">Sound</h3>
      ...
      {/* ADSR Envelope */}
      <div>
        <h3 className="text-text-muted font-semibold mb-2 border-b border-dark-border pb-1">Envelope (ADSR)</h3>
      ...
      {/* Modulation */}
      <div>
        <h3 className="text-text-muted font-semibold mb-2 border-b border-dark-border pb-1">Modulation</h3>
        <div className="flex gap-3 flex-wrap items-end">
      ...
      {/* Rhythm */}
      <div>
        <h3 className="text-text-muted font-semibold mb-2 border-b border-dark-border pb-1">Rhythm</h3>
