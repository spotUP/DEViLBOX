    ...
    >
      ...
      >
        ...
        <div style={{ ...style(containerWidth - 360, 145, 320, 80), display: 'flex', alignItems: 'center', gap: '12px', justifyContent: 'flex-end', paddingRight: '20px' }}>
          <div style={{ width: '65px' }}><Knob value={config.oscillator.pulseWidth ?? 1} min={0} max={1} defaultValue={1} onChange={(v) => updateOscillatorParam('pulseWidth', v)} label="PWM" size="md" color="#00cccc" formatValue={v => Math.round(50 + v * 49) + '%'} /></div>
        ...
        {showMods && (
          <>
            ...
            <div style={style(125, 325, 40, 40)}><Knob value={config.devilFish?.normalDecay ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateDevilFish('normalDecay', v)} label="N.Dec" size="sm" color="#ff3333" formatValue={v => Math.round(DECAY_MIN * Math.pow(DECAY_MAX / DECAY_MIN, v)) + ' ms'} /></div>
            <div style={style(195, 325, 40, 40)}><Knob value={config.devilFish?.accentDecay ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateDevilFish('accentDecay', v)} label="A.Dec" size="sm" color="#ff3333" formatValue={v => Math.round(DECAY_MIN * Math.pow(DECAY_MAX / DECAY_MIN, v)) + ' ms'} /></div>
            <div style={style(265, 325, 40, 40)}><Knob value={config.devilFish?.softAttack ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('softAttack', v)} label="S.Atk" size="sm" color="#ff3333" formatValue={v => (0.3 * Math.pow(100, v)).toFixed(1) + ' ms'} /></div>
            <div style={style(335, 325, 40, 40)}><Knob value={config.devilFish?.accentSoftAttack ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateDevilFish('accentSoftAttack', v)} label="A.Atk" size="sm" color="#ff3333" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(405, 325, 40, 40)}><Knob value={config.devilFish?.passbandCompensation ?? 0.9} min={0} max={1} defaultValue={0.9} onChange={(v) => updateDevilFish('passbandCompensation', v)} label="Comp" size="sm" color="#ff3333" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(475, 325, 40, 40)}><Knob value={config.devilFish?.resTracking ?? 0.7} min={0} max={1} defaultValue={0.7} onChange={(v) => updateDevilFish('resTracking', v)} label="R.Trk" size="sm" color="#ff3333" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(545, 325, 40, 40)}><Knob value={config.slide?.time ?? 0.17} min={0} max={1} defaultValue={0.17} onChange={updateSlide} label="Slide" size="sm" color="#ff3333" formatValue={v => Math.round(SLIDE_MIN * Math.pow(SLIDE_MAX / SLIDE_MIN, v)) + ' ms'} /></div>
            <div style={style(615, 325, 40, 40)}><Knob value={config.devilFish?.filterInputDrive ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('filterInputDrive', v)} label="Drive" size="sm" color="#ff3333" formatValue={v => (v * 10).toFixed(1)} /></div>

            {/* Extended Params */}
            <div style={style(680, 325, 40, 40)}><Knob value={config.devilFish?.diodeCharacter ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('diodeCharacter', v)} label="Diode" size="sm" color="#ff9900" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(740, 325, 40, 40)}><Knob value={config.devilFish?.duffingAmount ?? 0} min={-1} max={1} defaultValue={0} bipolar onChange={(v) => updateDevilFish('duffingAmount', v)} label="Duff" size="sm" color="#ff9900" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(800, 325, 40, 40)}><Knob value={config.devilFish?.filterFmDepth ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('filterFmDepth', v)} label="F.FM" size="sm" color="#ff9900" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(860, 325, 40, 40)}><Knob value={config.devilFish?.lpBpMix ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('lpBpMix', v)} label="LP/BP" size="sm" color="#ff9900" formatValue={v => v < 0.05 ? 'LP' : v > 0.95 ? 'BP' : 'Mix'} /></div>
            <div style={style(920, 325, 40, 40)}><Knob value={config.devilFish?.filterTracking ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('filterTracking', v)} label="K.Trk" size="sm" color="#ff9900" formatValue={v => Math.round(v * 100) + '%'} /></div>
            ...
            <div style={style(60, 395, 40, 40)}><Knob value={config.devilFish?.korgBite ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('korgBite', v)} label="Bite" size="sm" color="#06b6d4" formatValue={v => Math.round(v * 100) + '%'} disabled={config.devilFish?.filterSelect !== 5} /></div>
            <div style={style(120, 395, 40, 40)}><Knob value={config.devilFish?.korgClip ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('korgClip', v)} label="Clip" size="sm" color="#06b6d4" formatValue={v => Math.round(v * 100) + '%'} disabled={config.devilFish?.filterSelect !== 5} /></div>
            <div style={style(180, 395, 40, 40)}><Knob value={config.devilFish?.korgCrossmod ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('korgCrossmod', v)} label="XMod" size="sm" color="#06b6d4" formatValue={v => Math.round(v * 100) + '%'} disabled={config.devilFish?.filterSelect !== 5} /></div>
            <div style={style(240, 395, 40, 40)}><Knob value={config.devilFish?.korgQSag ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('korgQSag', v)} label="Q.Sag" size="sm" color="#06b6d4" formatValue={v => Math.round(v * 100) + '%'} disabled={config.devilFish?.filterSelect !== 5} /></div>
            <div style={style(300, 395, 40, 40)}><Knob value={config.devilFish?.korgSharpness ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateDevilFish('korgSharpness', v)} label="Sharp" size="sm" color="#06b6d4" formatValue={v => Math.round(v * 100) + '%'} disabled={config.devilFish?.filterSelect !== 5} /></div>

            <div style={labelStyle(400, 380, 200)} className="text-yellow-400/60 text-[9px]">EXTRAS</div>
            <div style={style(420, 395, 40, 40)}><Knob value={config.devilFish?.stageNLAmount ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('stageNLAmount', v)} label="StgNL" size="sm" color="#eab308" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(480, 395, 40, 40)}><Knob value={config.devilFish?.ensembleAmount ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDevilFish('ensembleAmount', v)} label="Ensem" size="sm" color="#eab308" formatValue={v => Math.round(v * 100) + '%'} /></div>
        ...
        {showLfo && (
          <>
            <div style={style(60, 480, 65, 65, modsShift)}><Knob value={config.lfo?.rate ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateLfo('rate', v)} label="Rate" size="md" color="#a855f7" formatValue={v => { const r = LFO_RATE_MIN * Math.pow(LFO_RATE_MAX/LFO_RATE_MIN, v); return r >= 10 ? r.toFixed(1) + 'Hz' : r.toFixed(2) + 'Hz'; }} /></div>
            <div style={style(170, 480, 65, 65, modsShift)}><Knob value={config.lfo?.contour ?? 0} min={-1} max={1} defaultValue={0} bipolar onChange={(v) => updateLfo('contour', v)} label="Contour" size="md" color="#a855f7" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(280, 480, 65, 65, modsShift)}><Knob value={config.lfo?.pitchDepth ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateLfo('pitchDepth', v)} label="Pitch" size="md" color="#a855f7" formatValue={v => '+' + Math.round(v * 12) + ' semi'} /></div>
            <div style={style(390, 480, 65, 65, modsShift)}><Knob value={config.lfo?.pwmDepth ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateLfo('pwmDepth', v)} label="PWM" size="md" color="#a855f7" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(500, 480, 65, 65, modsShift)}><Knob value={config.lfo?.filterDepth ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateLfo('filterDepth', v)} label="Filter" size="md" color="#a855f7" formatValue={v => '+' + (v * 2).toFixed(1) + ' oct'} /></div>
            <div style={style(610, 480, 65, 65, modsShift)}><Knob value={config.lfo?.stiffDepth ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateLfo('stiffDepth', v)} label="Stiff" size="md" color="#a855f7" formatValue={v => Math.round(v * 100) + '%'} /></div>
        ...
        {showFx && (
          <>
            ...
            <div style={style(155, 635, 40, 40, lfoShift)}><Knob value={config.chorus?.mix ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateChorus('mix', v)} label="Mix" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>

            <div style={labelStyle(200, 615, 120, lfoShift)} className="text-green-400/60 text-[10px]">PHASER</div>
            <div style={style(220, 635, 40, 40, lfoShift)}><Knob value={config.phaser?.rate ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updatePhaser('rate', v)} label="Rate" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(270, 635, 40, 40, lfoShift)}><Knob value={config.phaser?.depth ?? 0.7} min={0} max={1} defaultValue={0.7} onChange={(v) => updatePhaser('depth', v)} label="Width" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(320, 635, 40, 40, lfoShift)}><Knob value={config.phaser?.feedback ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updatePhaser('feedback', v)} label="FB" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(370, 635, 40, 40, lfoShift)}><Knob value={config.phaser?.mix ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updatePhaser('mix', v)} label="Mix" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>

            <div style={labelStyle(460, 615, 120, lfoShift)} className="text-green-400/60 text-[10px]">DELAY</div>
            <div style={style(480, 635, 40, 40, lfoShift)}><Knob value={config.delay?.time ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateDelay('time', v)} label="Time" size="sm" color="#22c55e" formatValue={v => (0.25 + v * 15.75).toFixed(2)} /></div>
            <div style={style(530, 635, 40, 40, lfoShift)}><Knob value={config.delay?.feedback ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDelay('feedback', v)} label="FB" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(580, 635, 40, 40, lfoShift)}><Knob value={config.delay?.tone ?? 0.5} min={0} max={1} defaultValue={0.5} onChange={(v) => updateDelay('tone', v)} label="Tone" size="sm" color="#22c55e" formatValue={v => v < 0.4 ? 'LP' : v > 0.6 ? 'HP' : 'Bypass'} /></div>
            <div style={style(630, 635, 40, 40, lfoShift)}><Knob value={config.delay?.mix ?? 0} min={0} max={1} defaultValue={0} onChange={(v) => updateDelay('mix', v)} label="Mix" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>
            <div style={style(680, 635, 40, 40, lfoShift)}><Knob value={config.delay?.stereo ?? 0.75} min={0} max={1} defaultValue={0.75} onChange={(v) => updateDelay('stereo', v)} label="Spread" size="sm" color="#22c55e" formatValue={v => Math.round(v * 100) + '%'} /></div>
          </>
        )}
