    ...
    <div className="p-4 space-y-4 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="p-2 rounded bg-[#1a2a1a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              ...
              <Knob label="Volume" value={m.osc1Volume} min={0} max={1} size="sm" color="#4ade80" onChange={(v) => update('osc1Volume', v)} />
              <Knob label="Tune" value={m.osc1Tune} min={0} max={1} size="sm" color="#facc15" bipolar onChange={(v) => update('osc1Tune', v)} />
              <Knob label="Fine" value={m.osc1FineTune} min={0} max={1} size="sm" color="#facc15" bipolar onChange={(v) => update('osc1FineTune', v)} />
              <Knob label="PW" value={m.osc1PW} min={0} max={1} size="sm" color="#60a5fa" onChange={(v) => update('osc1PW', v)} />
              <Knob label="Phase" value={m.osc1Phase} min={0} max={1} size="sm" color="#818cf8" onChange={(v) => update('osc1Phase', v)} />
          ...
          <div className="p-2 rounded bg-[#1a2a1a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              ...
              <Knob label="Volume" value={m.osc2Volume} min={0} max={1} size="sm" color="#4ade80" onChange={(v) => update('osc2Volume', v)} />
              <Knob label="Tune" value={m.osc2Tune} min={0} max={1} size="sm" color="#facc15" bipolar onChange={(v) => update('osc2Tune', v)} />
              <Knob label="Fine" value={m.osc2FineTune} min={0} max={1} size="sm" color="#facc15" bipolar onChange={(v) => update('osc2FineTune', v)} />
              <Knob label="Phase" value={m.osc2Phase} min={0} max={1} size="sm" color="#818cf8" onChange={(v) => update('osc2Phase', v)} />
              <Knob label="FM" value={m.osc2FM} min={0} max={1} size="sm" color="#f472b6" onChange={(v) => update('osc2FM', v)} />
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <Knob label="Cutoff" value={m.cutoff} min={0} max={1} size="sm" color="#a855f7" onChange={(v) => update('cutoff', v)} />
          <Knob label="Reso" value={m.resonance} min={0} max={1} size="sm" color="#a855f7" onChange={(v) => update('resonance', v)} />
          <Knob label="Drive" value={m.filterDrive} min={0} max={1} size="sm" color="#ef4444" onChange={(v) => update('filterDrive', v)} />
          <Knob label="Key Follow" value={m.keyFollow} min={0} max={1} size="sm" color="#818cf8" onChange={(v) => update('keyFollow', v)} />
          <Knob label="Contour" value={m.filterContour} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('filterContour', v)} />
          <Knob label="Vel Cutoff" value={m.velocityCutoff} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('velocityCutoff', v)} />
          <Knob label="High Pass" value={m.highPass} min={0} max={1} size="sm" color="#a855f7" onChange={(v) => update('highPass', v)} />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="p-2 rounded bg-[#1a1a2a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              <Knob label="A" value={m.ampAttack} min={0} max={1} size="sm" color="#ef4444" onChange={(v) => update('ampAttack', v)} />
              <Knob label="D" value={m.ampDecay} min={0} max={1} size="sm" color="#ef4444" onChange={(v) => update('ampDecay', v)} />
              <Knob label="S" value={m.ampSustain} min={0} max={1} size="sm" color="#ef4444" onChange={(v) => update('ampSustain', v)} />
              <Knob label="R" value={m.ampRelease} min={0} max={1} size="sm" color="#ef4444" onChange={(v) => update('ampRelease', v)} />
              <Knob label="Vel" value={m.velocityVolume} min={0} max={1} size="sm" color="#f87171" onChange={(v) => update('velocityVolume', v)} />
            </div>
          </div>
          ...
          <div className="p-2 rounded bg-[#2a1a2a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              <Knob label="A" value={m.filterAttack} min={0} max={1} size="sm" color="#a855f7" onChange={(v) => update('filterAttack', v)} />
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="p-2 rounded bg-[#1a2a2a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              <Knob label="Rate" value={m.lfo1Rate} min={0} max={1} size="sm" color="#22d3ee" onChange={(v) => update('lfo1Rate', v)} />
              <SelectControl label="Wave" value={m.lfo1Waveform} options={LFO_WAVE_NAMES} onChange={(v) => update('lfo1Waveform', v)} />
              <Knob label="Amount" value={m.lfo1Amount} min={0} max={1} size="sm" color="#22d3ee" onChange={(v) => update('lfo1Amount', v)} />
          ...
          <div className="p-2 rounded bg-[#1a2a2a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              <Knob label="Rate" value={m.lfo2Rate} min={0} max={1} size="sm" color="#2dd4bf" onChange={(v) => update('lfo2Rate', v)} />
              <SelectControl label="Wave" value={m.lfo2Waveform} options={LFO_WAVE_NAMES} onChange={(v) => update('lfo2Waveform', v)} />
              <Knob label="Amount" value={m.lfo2Amount} min={0} max={1} size="sm" color="#2dd4bf" onChange={(v) => update('lfo2Amount', v)} />
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="p-2 rounded bg-[#1a1a2a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              <Knob label="Wet" value={m.reverbWet} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('reverbWet', v)} />
              <Knob label="Decay" value={m.reverbDecay} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('reverbDecay', v)} />
              <Knob label="Pre-Dly" value={m.reverbPreDelay} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('reverbPreDelay', v)} />
              <Knob label="Hi Cut" value={m.reverbHighCut} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('reverbHighCut', v)} />
              <Knob label="Lo Cut" value={m.reverbLowCut} min={0} max={1} size="sm" color="#c084fc" onChange={(v) => update('reverbLowCut', v)} />
            </div>
          </div>
          ...
          <div className="p-2 rounded bg-[#1a1a2a]">
            ...
            <div className="flex flex-wrap gap-2 mt-1 items-end">
              <Knob label="Wet" value={m.delayWet} min={0} max={1} size="sm" color="#fb923c" onChange={(v) => update('delayWet', v)} />
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3 items-end">
          <Knob label="Volume" value={m.volume} min={0} max={1} size="sm" color="#4ade80" onChange={(v) => update('volume', v)} />
          <Knob label="Porta" value={m.portamento} min={0} max={1} size="sm" color="#60a5fa" onChange={(v) => update('portamento', v)} />
          <SelectControl label="Porta Mode" value={m.portamentoMode} options={['Auto', 'Always']} onChange={(v) => update('portamentoMode', v)} />
          <Knob label="Voices" value={m.voices} min={0} max={1} size="sm" color="#e2e8f0"
