...
export const ModularCanvasView: React.FC<ModularCanvasViewProps> = ({ config, onChange }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 right-4 flex items-center gap-2 bg-dark-bgSecondary/90 backdrop-blur-md border border-dark-border p-1 rounded-lg shadow-xl z-[99990]">
