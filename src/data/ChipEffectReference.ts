...
export const CHIP_EFFECT_REFERENCE: Record<number, ChipEffect[]> = {
  ...
  [FurnaceChipType.SNES]: [
    ...
    { command: '20xx', name: 'Set Attack', desc: 'SPC700 Attack rate (0-F).' },
    { command: '21xx', name: 'Set Decay', desc: 'SPC700 Decay rate (0-7).' },
    { command: '22xx', name: 'Set Sustain', desc: 'SPC700 Sustain level (0-7).' },
    { command: '23xx', name: 'Set Release', desc: 'SPC700 Release rate (00-1F).' },
  ],
  ...
  // === FM Systems ===
  [FurnaceChipType.OPN2]: FM_COMMON_EFFECTS, // OPN2 = YM2612
  [FurnaceChipType.OPM]: [
    ...FM_COMMON_EFFECTS,
  ...
  [FurnaceChipType.OPN]: FM_COMMON_EFFECTS, // OPN = YM2203
...
// Aliases
CHIP_EFFECT_REFERENCE[FurnaceChipType.SID_6581] = CHIP_EFFECT_REFERENCE[FurnaceChipType.SID];
CHIP_EFFECT_REFERENCE[FurnaceChipType.SID_8580] = CHIP_EFFECT_REFERENCE[FurnaceChipType.SID];
CHIP_EFFECT_REFERENCE[FurnaceChipType.OPNB_B] = CHIP_EFFECT_REFERENCE[FurnaceChipType.OPNB];
CHIP_EFFECT_REFERENCE[FurnaceChipType.ESFM] = CHIP_EFFECT_REFERENCE[FurnaceChipType.OPL3];
CHIP_EFFECT_REFERENCE[FurnaceChipType.NES] = CHIP_EFFECT_REFERENCE[FurnaceChipType.NES];
CHIP_EFFECT_REFERENCE[FurnaceChipType.MMC5] = CHIP_EFFECT_REFERENCE[FurnaceChipType.NES];
CHIP_EFFECT_REFERENCE[FurnaceChipType.VRC6] = [
  ...CHIP_EFFECT_REFERENCE[FurnaceChipType.NES],
