...
export const FORMAT_REGISTRY: FormatDefinition[] = [
  ...
  },
  {
    key: 'med',
    label: 'OctaMED',
    description: 'OctaMED/MED — native parser or UADE',
    family: 'amiga-native',
    matchMode: 'extension',
    extRegex: /\.(med|mmd[0-3])$/i,
    prefKey: 'med',
    nativeParser: { module: '@lib/import/formats/MEDParser', parseFn: 'parseMEDFile' },
    uadeFallback: true,
    libopenmptPlayable: true,
    hasMetadata: true,
  },
  ...
  },
  {
    key: 'sidmon2',
    label: 'SidMon II',
    description: 'SidMon II — native parser or UADE',
    family: 'amiga-native',
    matchMode: 'extension',
    extRegex: /\.(sid2|smn)$/i,
    prefKey: 'sidmon2',
  ...
  },
  {
    ...
    description: 'DigiBooster Pro — native parser or UADE',
    family: 'amiga-native',
    matchMode: 'extension',
    extRegex: /\.dbm$/i,
  ...
  // ── Prefix-based Amiga formats (native parser + UADE fallback) ────────────
  {
    key: 'benDaglish',
    label: 'Ben Daglish',
    description: 'Ben Daglish format (bd.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['bd.'],
    prefKey: 'benDaglish',
  ...
  },
  {
    ...
    description: 'Music Maker 4V (mm4.*/sdata.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['mm4.', 'sdata.'],
  ...
  },
  {
    ...
    description: 'Music Maker 8V (mm8.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['mm8.'],
  ...
  },
  {
    key: 'specialFX',
    label: 'Special FX',
    description: 'Special FX / SpecialFX_ST (doda.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['doda.'],
    prefKey: 'specialFX',
  ...
  },
  {
    ...
    description: 'MultiMedia Sound (mms.*/sfx20.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['mms.', 'sfx20.'],
  ...
  },
  {
    key: 'coreDesign',
    label: 'Core Design',
    description: 'Core Design (core.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['core.'],
    prefKey: 'coreDesign',
  ...
  },
  {
    key: 'paulSummers',
    label: 'Paul Summers',
    description: 'Paul Summers (snk.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['snk.'],
    prefKey: 'paulSummers',
  ...
  },
  {
    key: 'paulShields',
    label: 'Paul Shields',
    description: 'Paul Shields (ps.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['ps.'],
    prefKey: 'paulShields',
  ...
  },
  {
    key: 'anders0land',
    label: 'Anders Øland',
    description: 'Anders Øland (hot.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['hot.'],
    prefKey: 'anders0land',
  ...
  },
  {
    key: 'customMade',
    label: 'Custom Made',
    description: 'Custom Made (cm.*/rk.*/rkb.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['cm.'],
    prefKey: 'customMade',
  ...
  },
  {
    ...
    description: 'Jochen Hippel 7V (hip7.*/s7g.* prefix)',
    family: 'amiga-native',
    matchMode: 'prefix',
    prefixes: ['hip7.', 's7g.'],
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  ...([
    ['aam', 'ArtAndMagic'], ['abk', 'AMOS'], ['agi', 'Sierra AGI'],
    ...
    ['mkiio', 'Mark II (O)'],
    ['ea', 'EarAche'], ['mg', 'MG'], ['ems', 'EMS'], ['emsv6', 'EMS v6'],
    ['fw', 'Forgotten Worlds'], ['glue', 'GlueMon'], ['gm', 'GlueMon'],
    ['hd', 'Howie Davies'], ['hn', 'HN'], ['thn', 'THN'],
    ['mtp2', 'MajorTom 2'], ['arp', 'ARP'],
    ['hip', 'Jochen Hippel base'], ['mcmd', 'MCMD'], ['sog', 'SOG'],
    ['md', 'Mike Davies'], ['mk2', 'Mark II'], ['mkii', 'Mark II'],
    ['mok', 'Silmarils'], ['mso', 'Medley SO'],
    ['pn', 'Pokeynoise'],
    ['riff', 'RiffRaff'], ['s-c', 'Sean Connolly'], ['scn', 'Sean Connolly'],
    ['sa-p', 'Sonic Arranger P'], ['lion', 'Lion'], ['sa_old', 'Sonic Arranger Old'], ['sas', 'SAS'],
    ['scumm', 'SCUMM'], ['sdr', 'SynthDream'],
