...
const CMD_SET_FROM_ADD  =  7;
const CMD_FROM_ADD      =  8;
const CMD_SET_SPEED     =  9;
const CMD_ADD_PITCH     = 10;
const CMD_ADD_VOLUME    = 11;
const CMD_TREMOLO       = 12;
const CMD_VIBRATO       = 13;
const CMD_SAMPLE_VIB    = 14;
const CMD_PITCH_SLIDE_TO= 15;
const CMD_RETRIG        = 16;
const CMD_EMPHASIS      = 17;
