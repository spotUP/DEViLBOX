...
// Game Boy audio register addresses (memory-mapped I/O) - exported for reference
export const GB_AUDIO_REGS = {
...
function createZ80Driver(): {
  ...
  // HRAM variables (FF80-FFFE) - document memory layout
  const HRAM_DATA_PTR_LO = 0xFF80;
  const HRAM_DATA_PTR_HI = 0xFF81;
  const HRAM_PLAYING = 0xFF82;
  void HRAM_DATA_PTR_LO; void HRAM_DATA_PTR_HI; void HRAM_PLAYING;
