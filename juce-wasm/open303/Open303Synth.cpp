/**
 * Open303Synth.cpp - Roland TB-303 Synthesizer for WebAssembly
...
/**
 * Open303Synth - TB-303 Bass Synthesizer (WASM)
 */
class Open303Synth {
public:
    Open303Synth()
...
// Emscripten bindings
#ifdef __EMSCRIPTEN__
EMSCRIPTEN_BINDINGS(Open303Synth_bindings) {
    emscripten::class_<devilbox::Open303Synth>("Open303Synth")
        .constructor<>()
        .function("initialize", &devilbox::Open303Synth::initialize)
        .function("isInitialized", &devilbox::Open303Synth::isInitialized)
        .function("getSampleRate", &devilbox::Open303Synth::getSampleRate)
        .function("noteOn", &devilbox::Open303Synth::noteOn)
        .function("noteOff", &devilbox::Open303Synth::noteOff)
        ...
        .function("process", &devilbox::Open303Synth::processJS);
}
#endif
