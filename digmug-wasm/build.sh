...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_dm_create','_dm_destroy','_dm_subsong_count','_dm_select_subsong','_dm_channel_count','_dm_set_channel_mask','_dm_render','_dm_has_ended','_malloc','_free']" \
