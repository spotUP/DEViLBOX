...
emcc -O2 -Wall -Wextra -Wno-unused-function \
    ...
    -sEXPORTED_FUNCTIONS="['_fc_create','_fc_destroy','_fc_subsong_count','_fc_select_subsong','_fc_channel_count','_fc_set_channel_mask','_fc_render','_fc_render_multi','_fc_has_ended','_fc_get_instrument_count','_fc_get_num_patterns','_fc_get_num_sequences','_fc_get_cell','_fc_set_cell','_fc_get_sequence','_fc_set_sequence','_fc_get_instrument_param','_fc_set_instrument_param','_fc_export','_malloc','_free']" \
